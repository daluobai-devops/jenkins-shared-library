...
This project is indexed by GitNexus as **jenkins-shared-library** (307 symbols, 290 relationships, 0 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
