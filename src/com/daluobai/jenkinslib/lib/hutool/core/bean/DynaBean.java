...
import com.daluobai.jenkinslib.lib.hutool.core.bean.BeanException;
import com.daluobai.jenkinslib.lib.hutool.core.bean.BeanUtil;
import com.daluobai.jenkinslib.lib.hutool.core.bean.PropDesc;
import com.daluobai.jenkinslib.lib.hutool.core.clone.CloneSupport;
...
public class DynaBean extends CloneSupport<DynaBean> implements Serializable {
	...
	public <T> T get(String fieldName) throws BeanException {
		if (Map.class.isAssignableFrom(beanClass)) {
			...
			final PropDesc prop = com.daluobai.jenkinslib.lib.hutool.core.bean.BeanUtil.getBeanDesc(beanClass).getProp(fieldName);
			if (null == prop) {
	...
	public boolean containsProp(String fieldName) {
		if (Map.class.isAssignableFrom(beanClass)) {
			...
			return null != com.daluobai.jenkinslib.lib.hutool.core.bean.BeanUtil.getBeanDesc(beanClass).getProp(fieldName);
		}
	}
