...
/**
 * {@link com.daluobai.jenkinslib.lib.hutool.core.bean.copier.ValueProvider}属性拷贝到Bean中的拷贝器
 *
 * @param <T> 目标Bean类型
 * @since 5.8.0
 */
public class ValueProviderToBeanCopier<T> extends AbsCopier<com.daluobai.jenkinslib.lib.hutool.core.bean.copier.ValueProvider<String>, T> {
