...
public class URLEncodeUtil {
	...
	public static String encodeAll(String url, Charset charset) throws UtilException {
		return com.daluobai.jenkinslib.lib.hutool.core.net.RFC3986.UNRESERVED.encode(url, charset);
	}
	...
	public static String encode(String url, Charset charset) {
		return com.daluobai.jenkinslib.lib.hutool.core.net.RFC3986.PATH.encode(url, charset);
	}
	...
	public static String encodeQuery(String url, Charset charset) {
		return com.daluobai.jenkinslib.lib.hutool.core.net.RFC3986.QUERY.encode(url, charset);
	}
	...
	public static String encodePathSegment(String url, Charset charset) {
		...
		return com.daluobai.jenkinslib.lib.hutool.core.net.RFC3986.SEGMENT.encode(url, charset);
	}
