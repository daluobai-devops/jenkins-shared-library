package com.daluobai.jenkinslib.lib.hutool.core.net.url;

import com.daluobai.jenkinslib.lib.hutool.core.builder.Builder;
import com.daluobai.jenkinslib.lib.hutool.core.lang.Assert;
import com.daluobai.jenkinslib.lib.hutool.core.net.RFC3986;
import com.daluobai.jenkinslib.lib.hutool.core.net.url.UrlPath;
...
public final class UrlBuilder implements Builder<String> {
	 ...
	 * 路径，例如/aa/bb/cc
	 */
	private com.daluobai.jenkinslib.lib.hutool.core.net.url.UrlPath path;
	/**
	 * 查询语句，例如a=1&amp;b=2
	 */
	private com.daluobai.jenkinslib.lib.hutool.core.net.url.UrlQuery query;
	/**
	 * 标识符，例如#后边的部分
	 */
	...
	public static UrlBuilder of(String scheme, String host, int port, String path, String query, String fragment, Charset charset) {
		return of(scheme, host, port,
				com.daluobai.jenkinslib.lib.hutool.core.net.url.UrlPath.of(path, charset),
				com.daluobai.jenkinslib.lib.hutool.core.net.url.UrlQuery.of(query, charset, false), fragment, charset);
	}
	 ...
	 * @return UrlBuilder
	 */
	public static UrlBuilder of(String scheme, String host, int port, com.daluobai.jenkinslib.lib.hutool.core.net.url.UrlPath path, com.daluobai.jenkinslib.lib.hutool.core.net.url.UrlQuery query, String fragment, Charset charset) {
	 ...
	 */
	public UrlBuilder(String scheme, String host, int port, com.daluobai.jenkinslib.lib.hutool.core.net.url.UrlPath path, com.daluobai.jenkinslib.lib.hutool.core.net.url.UrlQuery query, String fragment, Charset charset) {
	 ...
	 */
	public com.daluobai.jenkinslib.lib.hutool.core.net.url.UrlPath getPath() {
		return path;
	}
	...
	public UrlBuilder setWithEndTag(boolean withEngTag) {
		if (null == this.path) {
			this.path = new com.daluobai.jenkinslib.lib.hutool.core.net.url.UrlPath();
		}
	 ...
	 * @return this
	 */
	public UrlBuilder setPath(com.daluobai.jenkinslib.lib.hutool.core.net.url.UrlPath path) {
		this.path = path;
		return this;
	}
	...
	public UrlBuilder addPath(CharSequence path) {
		com.daluobai.jenkinslib.lib.hutool.core.net.url.UrlPath.of(path, this.charset).getSegments().forEach(this::addPathSegment);
		return this;
	}
	 ...
	 */
	public com.daluobai.jenkinslib.lib.hutool.core.net.url.UrlQuery getQuery() {
		return query;
	}
	 ...
	 * @return this
	 */
	public UrlBuilder setQuery(com.daluobai.jenkinslib.lib.hutool.core.net.url.UrlQuery query) {
		this.query = query;
		return this;
	}
