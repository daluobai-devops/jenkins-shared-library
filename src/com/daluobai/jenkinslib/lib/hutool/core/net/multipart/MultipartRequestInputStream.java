...
public class MultipartRequestInputStream extends BufferedInputStream {
	...
	protected com.daluobai.jenkinslib.lib.hutool.core.net.multipart.UploadFileHeader lastHeader;

	public com.daluobai.jenkinslib.lib.hutool.core.net.multipart.UploadFileHeader getLastHeader() {
		return lastHeader;
	}
	 ...
	 * @throws IOException 读取异常
	 */
	public com.daluobai.jenkinslib.lib.hutool.core.net.multipart.UploadFileHeader readDataHeader(Charset encoding) throws IOException {
