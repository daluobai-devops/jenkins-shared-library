...
import com.daluobai.jenkinslib.lib.hutool.core.img.ColorUtil;
		...
		for (int i = 0; i < len; i++) {
			if (null == color) {
				...
				if (null != compareColor && minColorDistance > 0) {
					g.setColor(com.daluobai.jenkinslib.lib.hutool.core.img.ImgUtil.randomColor(compareColor,minColorDistance));
				}else {
					g.setColor(com.daluobai.jenkinslib.lib.hutool.core.img.ImgUtil.randomColor());
				}
			}
