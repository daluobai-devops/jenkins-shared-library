package com.daluobai.jenkinslib.lib.hutool.core.img;

import com.daluobai.jenkinslib.lib.hutool.core.codec.Base64;
import com.daluobai.jenkinslib.lib.hutool.core.img.*;
import com.daluobai.jenkinslib.lib.hutool.core.img.Img;
...
import com.daluobai.jenkinslib.lib.hutool.core.io.resource.Resource;
...
public class ImgUtil {
	...
	public static void scale(Image srcImg, File destFile, float scale) throws IORuntimeException {
		com.daluobai.jenkinslib.lib.hutool.core.img.Img.from(srcImg).setTargetImageType(FileUtil.extName(destFile)).scale(scale).write(destFile);
	}
	...
	public static Image scale(Image srcImg, float scale) {
		return com.daluobai.jenkinslib.lib.hutool.core.img.Img.from(srcImg).scale(scale).getImg();
	}
	...
	public static Image scale(Image srcImg, int width, int height) {
		return com.daluobai.jenkinslib.lib.hutool.core.img.Img.from(srcImg).scale(width, height).getImg();
	}
	...
	public static void scale(File srcImageFile, File destImageFile, int width, int height, Color fixedColor) throws IORuntimeException {
		com.daluobai.jenkinslib.lib.hutool.core.img.Img img = null;
		try {
			img = com.daluobai.jenkinslib.lib.hutool.core.img.Img.from(srcImageFile);
	...
	public static Image scale(Image srcImage, int width, int height, Color fixedColor) {
		return com.daluobai.jenkinslib.lib.hutool.core.img.Img.from(srcImage).scale(width, height, fixedColor).getImg();
	}
	...
	public static Image cut(Image srcImage, Rectangle rectangle) {
		return com.daluobai.jenkinslib.lib.hutool.core.img.Img.from(srcImage).setPositionBaseCentre(false).cut(rectangle).getImg();
	}
	...
	public static Image cut(Image srcImage, int x, int y, int radius) {
		return com.daluobai.jenkinslib.lib.hutool.core.img.Img.from(srcImage).cut(x, y, radius).getImg();
	}
	...
	public static void convert(Image srcImage, String formatName, ImageOutputStream destImageStream) {
		com.daluobai.jenkinslib.lib.hutool.core.img.Img.from(srcImage).setTargetImageType(formatName).write(destImageStream);
	}
	...
	public static Image gray(Image srcImage) {
		return com.daluobai.jenkinslib.lib.hutool.core.img.Img.from(srcImage).gray().getImg();
	}
	...
	public static Image binary(Image srcImage) {
		return com.daluobai.jenkinslib.lib.hutool.core.img.Img.from(srcImage).binary().getImg();
	}
	...
	public static Image pressText(Image srcImage, String pressText, Color color, Font font, int x, int y, float alpha) {
		return com.daluobai.jenkinslib.lib.hutool.core.img.Img.from(srcImage).pressText(pressText, color, font, x, y, alpha).getImg();
	}
	...
	public static Image pressImage(Image srcImage, Image pressImg, int x, int y, float alpha) {
		return com.daluobai.jenkinslib.lib.hutool.core.img.Img.from(srcImage).pressImage(pressImg, x, y, alpha).getImg();
	}
	...
	public static Image pressImage(Image srcImage, Image pressImg, Rectangle rectangle, float alpha) {
		return com.daluobai.jenkinslib.lib.hutool.core.img.Img.from(srcImage).pressImage(pressImg, rectangle, alpha).getImg();
	}
	...
	public static Image rotate(Image image, int degree) {
		return com.daluobai.jenkinslib.lib.hutool.core.img.Img.from(image).rotate(degree).getImg();
	}
	...
	public static Image flip(Image image) {
		return com.daluobai.jenkinslib.lib.hutool.core.img.Img.from(image).flip().getImg();
	}
