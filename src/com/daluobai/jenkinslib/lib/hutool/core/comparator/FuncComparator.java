package com.daluobai.jenkinslib.lib.hutool.core.comparator;

import com.daluobai.jenkinslib.lib.hutool.core.comparator.ComparatorException;
import com.daluobai.jenkinslib.lib.hutool.core.comparator.CompareUtil;
import com.daluobai.jenkinslib.lib.hutool.core.comparator.NullComparator;
...
public class FuncComparator<T> extends NullComparator<T> {
	...
	public FuncComparator(final boolean nullGreater, final boolean compareSelf, final Function<T, Comparable<?>> func) {
		super(nullGreater, (a, b)->{
			...
			int result = com.daluobai.jenkinslib.lib.hutool.core.comparator.CompareUtil.compare(v1, v2, nullGreater);
