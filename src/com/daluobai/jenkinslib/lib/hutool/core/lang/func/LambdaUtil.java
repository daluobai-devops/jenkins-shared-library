package com.daluobai.jenkinslib.lib.hutool.core.lang.func;
...
public class LambdaUtil {
	 ...
	 * @author VampireAchao
	 */
	public static <R> Class<R> getRealClass(com.daluobai.jenkinslib.lib.hutool.core.lang.func.Func0<?> func) {
	 ...
	 * @return 返回解析后的结果
	 */
	public static <T> SerializedLambda resolve(com.daluobai.jenkinslib.lib.hutool.core.lang.func.Func1<T, ?> func) {
	 ...
	 * @since 5.7.23
	 */
	public static <R> SerializedLambda resolve(com.daluobai.jenkinslib.lib.hutool.core.lang.func.Func0<R> func) {
		return _resolve(func);
	}
	 ...
	 * @return 函数名称
	 */
	public static <P> String getMethodName(com.daluobai.jenkinslib.lib.hutool.core.lang.func.Func1<P, ?> func) {
	 ...
	 * @since 5.7.23
	 */
	public static <R> String getMethodName(com.daluobai.jenkinslib.lib.hutool.core.lang.func.Func0<R> func) {
		return resolve(func).getImplMethodName();
	}
	 ...
	 * @author VampireAchao
	 */
	public static <P, R> Class<P> getRealClass(com.daluobai.jenkinslib.lib.hutool.core.lang.func.Func1<P, R> func) {
		final SerializedLambda lambda = resolve(func);
		checkLambdaTypeCanGetClass(lambda.getImplMethodKind());
