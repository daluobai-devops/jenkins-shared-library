...
public final class Singleton {
	...
	public static <T> T get(Class<T> clazz, Object... params) {
		com.daluobai.jenkinslib.lib.hutool.core.lang.Assert.notNull(clazz, "Class must be not null !");
	...
	public static <T> T get(String className, Object... params) {
		com.daluobai.jenkinslib.lib.hutool.core.lang.Assert.notBlank(className, "Class name must be not blank !");
