...
import com.daluobai.jenkinslib.lib.hutool.core.date.SystemClock;
import com.daluobai.jenkinslib.lib.hutool.core.lang.Assert;
import com.daluobai.jenkinslib.lib.hutool.core.lang.Pair;
import com.daluobai.jenkinslib.lib.hutool.core.lang.id.IdConstants;
...
public class Snowflake implements Serializable {
	...
	public Snowflake(Date epochDate, long workerId, long dataCenterId,
		...
		this.workerId = com.daluobai.jenkinslib.lib.hutool.core.lang.Assert.checkBetween(workerId, 0, MAX_WORKER_ID);
		this.dataCenterId = com.daluobai.jenkinslib.lib.hutool.core.lang.Assert.checkBetween(dataCenterId, 0, MAX_DATA_CENTER_ID);
	 ...
	 * @since 5.8.23
	 */
	public com.daluobai.jenkinslib.lib.hutool.core.lang.Pair<Long, Long> getIdScopeByTimestamp(long timestampStart, long timestampEnd) {
	 ...
	 * @since 5.8.23
	 */
	public com.daluobai.jenkinslib.lib.hutool.core.lang.Pair<Long, Long> getIdScopeByTimestamp(long timestampStart, long timestampEnd, boolean ignoreCenterAndWorker) {
		...
		if (ignoreCenterAndWorker) {
			...
			return com.daluobai.jenkinslib.lib.hutool.core.lang.Pair.of(startTimeMinId, endId);
		} else {
