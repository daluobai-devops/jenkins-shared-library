package com.daluobai.jenkinslib.lib.hutool.core.collection;

import com.daluobai.jenkinslib.lib.hutool.core.collection.AvgPartition;
import com.daluobai.jenkinslib.lib.hutool.core.collection.CollUtil;
import com.daluobai.jenkinslib.lib.hutool.core.collection.Partition;
import com.daluobai.jenkinslib.lib.hutool.core.collection.RandomAccessAvgPartition;
import com.daluobai.jenkinslib.lib.hutool.core.collection.RandomAccessPartition;
import com.daluobai.jenkinslib.lib.hutool.core.comparator.PinyinComparator;
import com.daluobai.jenkinslib.lib.hutool.core.comparator.PropertyComparator;
import com.daluobai.jenkinslib.lib.hutool.core.exceptions.ValidateException;
...
import com.daluobai.jenkinslib.lib.hutool.core.util.PageUtil;
...
public class ListUtil {
	...
	public static <T> List<T> page(int pageNo, int pageSize, List<T> list) {
		if (com.daluobai.jenkinslib.lib.hutool.core.collection.CollUtil.isEmpty(list)) {
	...
	public static <T> void page(List<T> list, int pageSize, Consumer<List<T>> pageListConsumer) {
		if (com.daluobai.jenkinslib.lib.hutool.core.collection.CollUtil.isEmpty(list) || pageSize <= 0) {
			return;
		}
	...
	public static <T> int[] indexOfAll(List<T> list, Matcher<T> matcher) {
		return com.daluobai.jenkinslib.lib.hutool.core.collection.CollUtil.indexOfAll(list, matcher);
	}
	...
	public static <T> void swapTo(List<T> list, T element, Integer targetIndex) {
		if (com.daluobai.jenkinslib.lib.hutool.core.collection.CollUtil.isNotEmpty(list)) {
	...
	public static <A, B, R> List<R> zip(List<A> listA, List<B> listB, BiFunction<A, B, R> zipper) {
		if (com.daluobai.jenkinslib.lib.hutool.core.collection.CollUtil.isEmpty(listA) || CollUtil.isEmpty(listB)) {
