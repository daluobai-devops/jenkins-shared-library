...
import com.daluobai.jenkinslib.lib.hutool.core.stream.CollectorUtil;
import com.daluobai.jenkinslib.lib.hutool.core.stream.StreamUtil;
...
public class CollStreamUtil {
	...
	public static <V, K> Map<K, V> toIdentityMap(Collection<V> collection, Function<V, K> key, boolean isParallel) {
		if (com.daluobai.jenkinslib.lib.hutool.core.collection.CollUtil.isEmpty(collection)) {
	...
	public static <E, T, U> Map<T, Map<U, E>> group2Map(Collection<E> collection,
		...
		if (com.daluobai.jenkinslib.lib.hutool.core.collection.CollUtil.isEmpty(collection) || key1 == null || key2 == null) {
			return MapUtil.newHashMap(0);
		}
	...
	public static <E, T> List<T> toList(Collection<E> collection, Function<E, T> function, boolean isParallel) {
		if (com.daluobai.jenkinslib.lib.hutool.core.collection.CollUtil.isEmpty(collection)) {
			return com.daluobai.jenkinslib.lib.hutool.core.collection.CollUtil.newArrayList();
		}
		return StreamUtil.of(collection, isParallel)
				.map(function)
