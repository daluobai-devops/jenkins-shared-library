package com.daluobai.jenkinslib.lib.hutool.core.builder;

import com.daluobai.jenkinslib.lib.hutool.core.builder.Builder;
import com.daluobai.jenkinslib.lib.hutool.core.builder.IDKey;
...
public class EqualsBuilder implements Builder<Boolean> {
	 ...
	 * </p>
	 */
	private static final ThreadLocal<Set<Pair<com.daluobai.jenkinslib.lib.hutool.core.builder.IDKey, com.daluobai.jenkinslib.lib.hutool.core.builder.IDKey>>> REGISTRY = new ThreadLocal<>();
	 ...
	 * @since 3.0
	 */
	static Set<Pair<com.daluobai.jenkinslib.lib.hutool.core.builder.IDKey, com.daluobai.jenkinslib.lib.hutool.core.builder.IDKey>> getRegistry() {
		return REGISTRY.get();
	}
	 ...
	 * @return the pair
	 */
	static Pair<com.daluobai.jenkinslib.lib.hutool.core.builder.IDKey, com.daluobai.jenkinslib.lib.hutool.core.builder.IDKey> getRegisterPair(final Object lhs, final Object rhs) {
		final com.daluobai.jenkinslib.lib.hutool.core.builder.IDKey left = new com.daluobai.jenkinslib.lib.hutool.core.builder.IDKey(lhs);
		final com.daluobai.jenkinslib.lib.hutool.core.builder.IDKey right = new com.daluobai.jenkinslib.lib.hutool.core.builder.IDKey(rhs);
	...
	static boolean isRegistered(final Object lhs, final Object rhs) {
		final Set<Pair<com.daluobai.jenkinslib.lib.hutool.core.builder.IDKey, com.daluobai.jenkinslib.lib.hutool.core.builder.IDKey>> registry = getRegistry();
		final Pair<com.daluobai.jenkinslib.lib.hutool.core.builder.IDKey, com.daluobai.jenkinslib.lib.hutool.core.builder.IDKey> pair = getRegisterPair(lhs, rhs);
		final Pair<com.daluobai.jenkinslib.lib.hutool.core.builder.IDKey, com.daluobai.jenkinslib.lib.hutool.core.builder.IDKey> swappedPair = new Pair<>(pair.getKey(), pair.getValue());
	...
	static void unregister(final Object lhs, final Object rhs) {
		Set<Pair<com.daluobai.jenkinslib.lib.hutool.core.builder.IDKey, com.daluobai.jenkinslib.lib.hutool.core.builder.IDKey>> registry = getRegistry();
		if (registry != null) {
			final Pair<com.daluobai.jenkinslib.lib.hutool.core.builder.IDKey, com.daluobai.jenkinslib.lib.hutool.core.builder.IDKey> pair = getRegisterPair(lhs, rhs);
