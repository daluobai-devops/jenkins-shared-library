...
public class HashCodeBuilder implements Builder<Integer> {
     ...
     * @since 2.3
     */
    private static final ThreadLocal<Set<com.daluobai.jenkinslib.lib.hutool.core.builder.IDKey>> REGISTRY = new ThreadLocal<>();
     ...
     * @since 2.3
     */
    private static Set<com.daluobai.jenkinslib.lib.hutool.core.builder.IDKey> getRegistry() {
        return REGISTRY.get();
    }
    ...
    private static boolean isRegistered(final Object value) {
        final Set<com.daluobai.jenkinslib.lib.hutool.core.builder.IDKey> registry = getRegistry();
        return registry != null && registry.contains(new com.daluobai.jenkinslib.lib.hutool.core.builder.IDKey(value));
    }
    ...
    static void register(final Object value) {
        synchronized (HashCodeBuilder.class) {
            if (getRegistry() == null) {
                REGISTRY.set(new HashSet<com.daluobai.jenkinslib.lib.hutool.core.builder.IDKey>());
            }
        }
        getRegistry().add(new com.daluobai.jenkinslib.lib.hutool.core.builder.IDKey(value));
    }
    ...
    static void unregister(final Object value) {
        Set<com.daluobai.jenkinslib.lib.hutool.core.builder.IDKey> registry = getRegistry();
        if (registry != null) {
            registry.remove(new com.daluobai.jenkinslib.lib.hutool.core.builder.IDKey(value));
            synchronized (HashCodeBuilder.class) {
                //read again
