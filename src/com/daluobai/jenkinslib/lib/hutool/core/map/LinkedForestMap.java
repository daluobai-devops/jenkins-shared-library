...
/**
 * {@link com.daluobai.jenkinslib.lib.hutool.core.map.ForestMap}的基本实现。
 *
 ...
 * 使用者可以通过{@link com.daluobai.jenkinslib.lib.hutool.core.map.ForestMap}本身的方法来对森林进行操作或访问，
 * 也可以在获取到{@link com.daluobai.jenkinslib.lib.hutool.core.map.TreeEntry}后，使用节点本身的方法对数进行操作或访问。
 *
 * @param <K> key类型
...
public class LinkedForestMap<K, V> implements ForestMap<K, V> {
	...
	/**
	 * 当前实例中是否存在对应的{@link com.daluobai.jenkinslib.lib.hutool.core.map.TreeEntry}实例
	 *
	 * @param value {@link com.daluobai.jenkinslib.lib.hutool.core.map.TreeEntry}实例
	 * @return 是否
	 */
	@Override
	 ...
	 */
	@Override
	public com.daluobai.jenkinslib.lib.hutool.core.map.TreeEntry<K, V> get(Object key) {
	 ...
	 */
	@Override
	public com.daluobai.jenkinslib.lib.hutool.core.map.TreeEntry<K, V> remove(Object key) {
		...
		if (target.hasParent()) {
			...
			final Map<K, com.daluobai.jenkinslib.lib.hutool.core.map.TreeEntry<K, V>> targetChildren = target.getChildren();
	...
	/**
	 * 返回当前实例中全部{@link com.daluobai.jenkinslib.lib.hutool.core.map.TreeEntry}组成的{@link Collection}集合
	 *
	 * @return 集合
	 */
	@Override
	public Collection<com.daluobai.jenkinslib.lib.hutool.core.map.TreeEntry<K, V>> values() {
		return new ArrayList<>(nodes.values());
	}

	/**
	 * 由key与{@link com.daluobai.jenkinslib.lib.hutool.core.map.TreeEntry}组成的键值对实体的{@link Set}集合。
	 * 注意，返回集合中{@link Entry#setValue(Object)}不支持调用。
	 *
	 * @return 集合
	 */
	@Override
	public Set<Entry<K, com.daluobai.jenkinslib.lib.hutool.core.map.TreeEntry<K, V>>> entrySet() {
	 ...
	 */
	private Entry<K, com.daluobai.jenkinslib.lib.hutool.core.map.TreeEntry<K, V>> wrap(Entry<K, TreeEntryNode<K, V>> nodeEntry) {
	 ...
	 */
	@Override
	public void linkNodes(K parentKey, K childKey, BiConsumer<com.daluobai.jenkinslib.lib.hutool.core.map.TreeEntry<K, V>, com.daluobai.jenkinslib.lib.hutool.core.map.TreeEntry<K, V>> consumer) {
	 ...
	 * @author huangchengxing
	 */
	public static class TreeEntryNode<K, V> implements com.daluobai.jenkinslib.lib.hutool.core.map.TreeEntry<K, V> {
		 ...
		 */
		@Override
		public void forEachChild(boolean includeSelf, Consumer<com.daluobai.jenkinslib.lib.hutool.core.map.TreeEntry<K, V>> nodeConsumer) {
		 ...
		 */
		@Override
		public Map<K, com.daluobai.jenkinslib.lib.hutool.core.map.TreeEntry<K, V>> getDeclaredChildren() {
		 ...
		 */
		@Override
		public Map<K, com.daluobai.jenkinslib.lib.hutool.core.map.TreeEntry<K, V>> getChildren() {
			final Map<K, com.daluobai.jenkinslib.lib.hutool.core.map.TreeEntry<K, V>> childrenMap = new LinkedHashMap<>();
		...
		/**
		 * 比较目标对象与当前{@link com.daluobai.jenkinslib.lib.hutool.core.map.TreeEntry}是否相等。<br>
		 * 默认只要{@link com.daluobai.jenkinslib.lib.hutool.core.map.TreeEntry#getKey()}的返回值相同，即认为两者相等
		 *
		 * @param o 目标对象
		 * @return 是否
		 */
		...
		public boolean equals(Object o) {
			...
			final com.daluobai.jenkinslib.lib.hutool.core.map.TreeEntry<?, ?> treeEntry = (com.daluobai.jenkinslib.lib.hutool.core.map.TreeEntry<?, ?>) o;
			return ObjectUtil.equals(this.getKey(), treeEntry.getKey());
		}

		/**
		 * 返回当前{@link com.daluobai.jenkinslib.lib.hutool.core.map.TreeEntry}的哈希值。<br>
		 * 默认总是返回{@link com.daluobai.jenkinslib.lib.hutool.core.map.TreeEntry#getKey()}的哈希值
		 *
		 * @return 哈希值
		 */
		@Override
	 ...
	 * @param <K> key类型
	 * @param <V> value类型
	 * @param <N> 包装的{@link com.daluobai.jenkinslib.lib.hutool.core.map.TreeEntry}类型
	 * @see #entrySet()
	 * @see #values()
	 */
	public static class EntryNodeWrapper<K, V, N extends com.daluobai.jenkinslib.lib.hutool.core.map.TreeEntry<K, V>> implements Entry<K, com.daluobai.jenkinslib.lib.hutool.core.map.TreeEntry<K, V>> {
		...
		@Override
		public com.daluobai.jenkinslib.lib.hutool.core.map.TreeEntry<K, V> getValue() {
			return entryNode;
		}

		@Override
		public com.daluobai.jenkinslib.lib.hutool.core.map.TreeEntry<K, V> setValue(TreeEntry<K, V> value) {
