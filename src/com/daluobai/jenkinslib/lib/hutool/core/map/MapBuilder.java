...
public class MapBuilder<K, V> implements Builder<Map<K, V>> {
	...
	public static <K, V> MapBuilder<K, V> create(boolean isLinked) {
		return create(com.daluobai.jenkinslib.lib.hutool.core.map.MapUtil.newHashMap(isLinked));
	}
	...
	public String join(String separator, final String keyValueSeparator) {
		return com.daluobai.jenkinslib.lib.hutool.core.map.MapUtil.join(this.map, separator, keyValueSeparator);
	}
	...
	public String joinIgnoreNull(String separator, final String keyValueSeparator) {
		return com.daluobai.jenkinslib.lib.hutool.core.map.MapUtil.joinIgnoreNull(this.map, separator, keyValueSeparator);
	}
