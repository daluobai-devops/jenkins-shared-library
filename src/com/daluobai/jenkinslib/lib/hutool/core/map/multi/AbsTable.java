package com.daluobai.jenkinslib.lib.hutool.core.map.multi;

import com.daluobai.jenkinslib.lib.hutool.core.collection.IterUtil;
import com.daluobai.jenkinslib.lib.hutool.core.collection.TransIter;
...
/**
 * 抽象{@link com.daluobai.jenkinslib.lib.hutool.core.map.multi.Table}接口实现<br>
 * 默认实现了：
 * <ul>
 ...
 * @since 5.7.23
 */
public abstract class AbsTable<R, C, V> implements com.daluobai.jenkinslib.lib.hutool.core.map.multi.Table<R, C, V> {

	@Override
	public boolean equals(Object obj) {
		if (obj == this) {
			return true;
		} else if (obj instanceof com.daluobai.jenkinslib.lib.hutool.core.map.multi.Table) {
			final com.daluobai.jenkinslib.lib.hutool.core.map.multi.Table<?, ?, ?> that = (com.daluobai.jenkinslib.lib.hutool.core.map.multi.Table<?, ?, ?>) obj;
