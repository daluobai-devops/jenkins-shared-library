...
import com.daluobai.jenkinslib.lib.hutool.core.map.FuncKeyMap;
import com.daluobai.jenkinslib.lib.hutool.core.map.MapBuilder;
...
public class CamelCaseMap<K, V> extends FuncKeyMap<K, V> {
	...
	public CamelCaseMap(int initialCapacity, float loadFactor) {
		this(com.daluobai.jenkinslib.lib.hutool.core.map.MapBuilder.create(new HashMap<>(initialCapacity, loadFactor)));
	}
