...
import com.daluobai.jenkinslib.lib.hutool.core.io.watch.WatchException;
import com.daluobai.jenkinslib.lib.hutool.core.io.watch.WatchKind;
import com.daluobai.jenkinslib.lib.hutool.core.io.watch.WatchServer;
import com.daluobai.jenkinslib.lib.hutool.core.io.watch.Watcher;
import com.daluobai.jenkinslib.lib.hutool.core.io.watch.watchers.WatcherChain;
...
public class WatchMonitor extends WatchServer {
	 ...
	 * 事件丢失
	 */
	public static final WatchEvent.Kind<?> OVERFLOW = com.daluobai.jenkinslib.lib.hutool.core.io.watch.WatchKind.OVERFLOW.getValue();
	/**
	 * 修改事件
	 */
	public static final WatchEvent.Kind<?> ENTRY_MODIFY = com.daluobai.jenkinslib.lib.hutool.core.io.watch.WatchKind.MODIFY.getValue();
	/**
	 * 创建事件
	 */
	public static final WatchEvent.Kind<?> ENTRY_CREATE = com.daluobai.jenkinslib.lib.hutool.core.io.watch.WatchKind.CREATE.getValue();
	/**
	 * 删除事件
	 */
	public static final WatchEvent.Kind<?> ENTRY_DELETE = com.daluobai.jenkinslib.lib.hutool.core.io.watch.WatchKind.DELETE.getValue();
	/**
	 * 全部事件
	 */
	 ...
	 * 监听器
	 */
	private com.daluobai.jenkinslib.lib.hutool.core.io.watch.Watcher watcher;
	//------------------------------------------------------ Static method start
	 ...
	 * @return WatchMonitor
	 */
	public WatchMonitor setWatcher(com.daluobai.jenkinslib.lib.hutool.core.io.watch.Watcher watcher) {
	 ...
	 */
	public void watch(com.daluobai.jenkinslib.lib.hutool.core.io.watch.Watcher watcher) throws WatchException {
		if (isClosed) {
