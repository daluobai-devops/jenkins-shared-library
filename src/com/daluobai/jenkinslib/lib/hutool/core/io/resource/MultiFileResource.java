...
import com.daluobai.jenkinslib.lib.hutool.core.io.resource.MultiResource;
...
public class MultiFileResource extends MultiResource {
	...
	public MultiFileResource add(File... files) {
		for (File file : files) {
			this.add(new com.daluobai.jenkinslib.lib.hutool.core.io.resource.FileResource(file));
		}
		return this;
	}
