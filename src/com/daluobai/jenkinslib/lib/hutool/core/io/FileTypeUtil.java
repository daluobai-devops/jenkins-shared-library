...
import com.daluobai.jenkinslib.lib.hutool.core.io.FileMagicNumber;
...
import com.daluobai.jenkinslib.lib.hutool.core.util.HexUtil;
...
public class FileTypeUtil {
	...
	public static String getType(InputStream in, int fileHeadSize) throws IORuntimeException {
		return getType((com.daluobai.jenkinslib.lib.hutool.core.io.IoUtil.readHex(in, fileHeadSize, false)));
	}
	...
	public static String getType(InputStream in, boolean isExact) throws IORuntimeException {
		...
		return isExact
			? getType(com.daluobai.jenkinslib.lib.hutool.core.io.IoUtil.readHex8192Upper(in))
			: getType(com.daluobai.jenkinslib.lib.hutool.core.io.IoUtil.readHex64Upper(in));
	}
	...
	public static String getType(InputStream in, String filename, boolean isExact) throws IORuntimeException {
		...
		if (null == typeName) {
			// 未成功识别类型，扩展名辅助识别
			typeName = com.daluobai.jenkinslib.lib.hutool.core.io.FileUtil.extName(filename);
		} else if ("zip".equals(typeName)) {
			// zip可能为docx、xlsx、pptx、jar、war、ofd等格式，扩展名辅助判断
			final String extName = com.daluobai.jenkinslib.lib.hutool.core.io.FileUtil.extName(filename);
	...
	public static String getType(File file, boolean isExact) throws IORuntimeException {
		if (false == com.daluobai.jenkinslib.lib.hutool.core.io.FileUtil.isFile(file)) {
			throw new IllegalArgumentException("Not a regular file!");
		}
		FileInputStream in = null;
		try {
			in = com.daluobai.jenkinslib.lib.hutool.core.io.IoUtil.toStream(file);
