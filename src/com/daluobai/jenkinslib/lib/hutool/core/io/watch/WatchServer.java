...
import com.daluobai.jenkinslib.lib.hutool.core.io.watch.WatchAction;
...
public class WatchServer extends Thread implements Closeable, Serializable {
	...
	public void registerPath(Path path, int maxDepth) {
		final WatchEvent.Kind<?>[] kinds = ArrayUtil.defaultIfEmpty(this.events, com.daluobai.jenkinslib.lib.hutool.core.io.watch.WatchKind.ALL);
	...
	public void watch(Watcher watcher, Filter<WatchEvent<?>> watchFilter) {
		watch((event, currentPath) -> {
			...
			if (kind == com.daluobai.jenkinslib.lib.hutool.core.io.watch.WatchKind.CREATE.getValue()) {
				watcher.onCreate(event, currentPath);
			} else if (kind == com.daluobai.jenkinslib.lib.hutool.core.io.watch.WatchKind.MODIFY.getValue()) {
				watcher.onModify(event, currentPath);
			} else if (kind == com.daluobai.jenkinslib.lib.hutool.core.io.watch.WatchKind.DELETE.getValue()) {
