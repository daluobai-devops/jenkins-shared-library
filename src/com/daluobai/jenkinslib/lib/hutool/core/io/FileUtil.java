package com.daluobai.jenkinslib.lib.hutool.core.io;

import com.daluobai.jenkinslib.lib.hutool.core.collection.CollUtil;
import com.daluobai.jenkinslib.lib.hutool.core.io.BOMInputStream;
import com.daluobai.jenkinslib.lib.hutool.core.io.FileTypeUtil;
...
import com.daluobai.jenkinslib.lib.hutool.core.io.LineHandler;
import com.daluobai.jenkinslib.lib.hutool.core.io.file.FileReader;
import com.daluobai.jenkinslib.lib.hutool.core.io.file.*;
import com.daluobai.jenkinslib.lib.hutool.core.io.file.FileWriter;
import com.daluobai.jenkinslib.lib.hutool.core.io.file.FileReader.ReaderHandler;
...
import com.daluobai.jenkinslib.lib.hutool.core.io.unit.DataSizeUtil;
import com.daluobai.jenkinslib.lib.hutool.core.lang.Assert;
import com.daluobai.jenkinslib.lib.hutool.core.thread.ThreadUtil;
...
public class FileUtil extends PathUtil {
	...
	public static List<String> listFileNames(String path) throws IORuntimeException {
		...
		try {
			...
			com.daluobai.jenkinslib.lib.hutool.core.io.IoUtil.close(jarFile);
		}
	}
	...
	public static boolean contentEquals(File file1, File file2) throws IORuntimeException {
		...
		try {
			...
			return com.daluobai.jenkinslib.lib.hutool.core.io.IoUtil.contentEquals(input1, input2);

		} finally {
			com.daluobai.jenkinslib.lib.hutool.core.io.IoUtil.close(input1);
			com.daluobai.jenkinslib.lib.hutool.core.io.IoUtil.close(input2);
		}
	}
	...
	public static boolean contentEqualsIgnoreEOL(File file1, File file2, Charset charset) throws IORuntimeException {
		...
		try {
			...
			return com.daluobai.jenkinslib.lib.hutool.core.io.IoUtil.contentEqualsIgnoreEOL(input1, input2);
		} finally {
			com.daluobai.jenkinslib.lib.hutool.core.io.IoUtil.close(input1);
			com.daluobai.jenkinslib.lib.hutool.core.io.IoUtil.close(input2);
		}
	...
	public static BufferedInputStream getInputStream(File file) throws IORuntimeException {
		return com.daluobai.jenkinslib.lib.hutool.core.io.IoUtil.toBuffered(com.daluobai.jenkinslib.lib.hutool.core.io.IoUtil.toStream(file));
	}
	...
	public static BufferedReader getBOMReader(File file) {
		return com.daluobai.jenkinslib.lib.hutool.core.io.IoUtil.getReader(getBOMInputStream(file));
	}
	...
	public static BufferedReader getReader(File file, String charsetName) throws IORuntimeException {
		return com.daluobai.jenkinslib.lib.hutool.core.io.IoUtil.getReader(getInputStream(file), CharsetUtil.charset(charsetName));
	}
	...
	public static BufferedReader getReader(File file, Charset charset) throws IORuntimeException {
		return com.daluobai.jenkinslib.lib.hutool.core.io.IoUtil.getReader(getInputStream(file), charset);
	}
	...
	public static String readString(URL url, Charset charset) throws IORuntimeException {
		...
		try {
			in = url.openStream();
			return com.daluobai.jenkinslib.lib.hutool.core.io.IoUtil.read(in, charset);
		} catch (IOException e) {
			throw new IORuntimeException(e);
		} finally {
			com.daluobai.jenkinslib.lib.hutool.core.io.IoUtil.close(in);
		}
	}
	...
	public static <T extends Collection<String>> T readLines(URL url, Charset charset, T collection) throws IORuntimeException {
		...
		try {
			in = url.openStream();
			return com.daluobai.jenkinslib.lib.hutool.core.io.IoUtil.readLines(in, charset, collection);
		} catch (IOException e) {
			throw new IORuntimeException(e);
		} finally {
			com.daluobai.jenkinslib.lib.hutool.core.io.IoUtil.close(in);
	...
	public static BufferedOutputStream getOutputStream(File file) throws IORuntimeException {
		...
		return com.daluobai.jenkinslib.lib.hutool.core.io.IoUtil.toBuffered(out);
	}
