...
/**
 * 合成注解代理类，用于为{@link com.daluobai.jenkinslib.lib.hutool.core.annotation.SynthesizedAnnotation}生成对应的合成注解代理对象
 *
 * @author huangchengxing
 * @see com.daluobai.jenkinslib.lib.hutool.core.annotation.SynthesizedAnnotation
...
public class SynthesizedAnnotationProxy implements InvocationHandler {
	...
	private final com.daluobai.jenkinslib.lib.hutool.core.annotation.SynthesizedAnnotation annotation;
	...
	public static <T extends Annotation> T create(
			...
			com.daluobai.jenkinslib.lib.hutool.core.annotation.SynthesizedAnnotation annotation) {
	 ...
	 */
	public static <T extends Annotation> T create(
			Class<T> annotationType, com.daluobai.jenkinslib.lib.hutool.core.annotation.SynthesizedAnnotation annotation) {
	...
	SynthesizedAnnotationProxy(AnnotationAttributeValueProvider annotationAttributeValueProvider, com.daluobai.jenkinslib.lib.hutool.core.annotation.SynthesizedAnnotation annotation) {
	 ...
	 * @author huangchengxing
	 */
	interface SyntheticProxyAnnotation extends com.daluobai.jenkinslib.lib.hutool.core.annotation.SynthesizedAnnotation {
