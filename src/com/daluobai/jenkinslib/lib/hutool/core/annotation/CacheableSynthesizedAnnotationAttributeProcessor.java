...
import com.daluobai.jenkinslib.lib.hutool.core.annotation.Hierarchical;
...
import com.daluobai.jenkinslib.lib.hutool.core.annotation.SynthesizedAnnotationAttributeProcessor;
import com.daluobai.jenkinslib.lib.hutool.core.lang.Assert;
import com.daluobai.jenkinslib.lib.hutool.core.map.multi.RowKeyTable;
import com.daluobai.jenkinslib.lib.hutool.core.map.multi.Table;
...
/**
 * <p>带缓存功能的{@link com.daluobai.jenkinslib.lib.hutool.core.annotation.SynthesizedAnnotationAttributeProcessor}实现，
...
public class CacheableSynthesizedAnnotationAttributeProcessor implements SynthesizedAnnotationAttributeProcessor {
	...
	private final Comparator<com.daluobai.jenkinslib.lib.hutool.core.annotation.Hierarchical> annotationComparator;
	 ...
	 */
	public CacheableSynthesizedAnnotationAttributeProcessor(Comparator<com.daluobai.jenkinslib.lib.hutool.core.annotation.Hierarchical> annotationComparator) {
	...
	/**
	 * 创建一个带缓存的注解值选择器，
	 * 默认按{@link com.daluobai.jenkinslib.lib.hutool.core.annotation.SynthesizedAnnotation#getVerticalDistance()}和{@link com.daluobai.jenkinslib.lib.hutool.core.annotation.SynthesizedAnnotation#getHorizontalDistance()}排序，
	 * 越靠前的越优先被取值。
	 */
