...
/**
 * <p>注解属性的关系类型 <br>
 * 若将被{@link com.daluobai.jenkinslib.lib.hutool.core.annotation.Link}注解的属性称为“原始属性”，而在{@link com.daluobai.jenkinslib.lib.hutool.core.annotation.Link}注解中指向的注解属性称为“关联属性”，
 * 则该枚举用于描述“原始属性”与“关联属性”在{@link SynthesizedAggregateAnnotation}处理过程中的作用关系。<br>
 * 根据在{@link com.daluobai.jenkinslib.lib.hutool.core.annotation.Link#type()}中指定的关系类型的不同，通过{@link SynthesizedAggregateAnnotation}合成的注解的属性值也将有所变化。
 *
 * <p>当一个注解中的所有属性同时具备多种关系时，将依次按下述顺序处理：
 * <ol>
 *     <li>属性上的{@link com.daluobai.jenkinslib.lib.hutool.core.annotation.Alias}注解；</li>
 *     <li>属性上的{@link com.daluobai.jenkinslib.lib.hutool.core.annotation.Link}注解，且{@link com.daluobai.jenkinslib.lib.hutool.core.annotation.Link#type()}为{@link #MIRROR_FOR}；</li>
 *     <li>属性上的{@link com.daluobai.jenkinslib.lib.hutool.core.annotation.Link}注解，且{@link com.daluobai.jenkinslib.lib.hutool.core.annotation.Link#type()}为{@link #FORCE_ALIAS_FOR}；</li>
 *     <li>属性上的{@link com.daluobai.jenkinslib.lib.hutool.core.annotation.Link}注解，且{@link com.daluobai.jenkinslib.lib.hutool.core.annotation.Link#type()}为{@link #ALIAS_FOR}；</li>
 * </ol>
 *
