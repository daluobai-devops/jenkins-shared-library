...
/**
 * {@link com.daluobai.jenkinslib.lib.hutool.core.annotation.AnnotationSynthesizer}的基本实现
 *
...
public abstract class AbstractAnnotationSynthesizer<T> implements AnnotationSynthesizer {
	 ...
	 */
	protected final Map<Class<? extends Annotation>, com.daluobai.jenkinslib.lib.hutool.core.annotation.SynthesizedAnnotation> synthesizedAnnotationMap;
	 ...
	 * @return 合成注解
	 */
	protected abstract Map<Class<? extends Annotation>, com.daluobai.jenkinslib.lib.hutool.core.annotation.SynthesizedAnnotation> loadAnnotations();
	 ...
	 * @return 最终所需的合成注解
	 */
	protected abstract <A extends Annotation> A synthesize(Class<A> annotationType, com.daluobai.jenkinslib.lib.hutool.core.annotation.SynthesizedAnnotation annotation);
	 ...
	 */
	@Override
	public com.daluobai.jenkinslib.lib.hutool.core.annotation.SynthesizedAnnotation getSynthesizedAnnotation(Class<?> annotationType) {
	 ...
	 */
	@Override
	public Map<Class<? extends Annotation>, com.daluobai.jenkinslib.lib.hutool.core.annotation.SynthesizedAnnotation> getAllSynthesizedAnnotation() {
