...
/**
 * 注解代理<br>
 * 通过代理指定注解，可以自定义调用注解的方法逻辑，如支持{@link com.daluobai.jenkinslib.lib.hutool.core.annotation.Alias} 注解
 *
 * @param <T> 注解类型
 * @since 5.7.23
 */
public class AnnotationProxy<T extends Annotation> implements Annotation, InvocationHandler, Serializable {
	...
	public Object invoke(Object proxy, Method method, Object[] args) throws Throwable {
		...
		// 注解别名
		com.daluobai.jenkinslib.lib.hutool.core.annotation.Alias alias = method.getAnnotation(Alias.class);
		if(null != alias){
