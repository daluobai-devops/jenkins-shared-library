...
/**
 * <p>{@link com.daluobai.jenkinslib.lib.hutool.core.annotation.Link}的子注解。表示“原始属性”将作为“关联属性”的别名。
 * <ul>
 *     <li>当“原始属性”为默认值时，获取“关联属性”将返回“关联属性”本身的值；</li>
 *     <li>当“原始属性”不为默认值时，获取“关联属性”将返回“原始属性”的值；</li>
 * </ul>
 * <b>注意，该注解与{@link com.daluobai.jenkinslib.lib.hutool.core.annotation.Link}、{@link ForceAliasFor}或{@link MirrorFor}一起使用时，将只有被声明在最上面的注解会生效</b>
 *
 * @author huangchengxing
 * @see com.daluobai.jenkinslib.lib.hutool.core.annotation.Link
 * @see RelationType#ALIAS_FOR
 */
@com.daluobai.jenkinslib.lib.hutool.core.annotation.Link(type = RelationType.ALIAS_FOR)
@Documented
