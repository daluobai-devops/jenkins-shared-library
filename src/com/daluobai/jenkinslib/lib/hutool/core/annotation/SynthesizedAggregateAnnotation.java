...
import com.daluobai.jenkinslib.lib.hutool.core.annotation.AggregateAnnotation;
 ...
 * 当实例被创建时，会获取到这些注解对象，并使用{@link com.daluobai.jenkinslib.lib.hutool.core.annotation.SynthesizedAnnotationSelector}对类型相同的注解进行过滤，
 * 并最终得到类型不重复的有效注解对象。这些有效注解将被包装为{@link com.daluobai.jenkinslib.lib.hutool.core.annotation.SynthesizedAnnotation}，
 * 然后最终用于“合成”一个{@link SynthesizedAggregateAnnotation}。<br>
 * {@link com.daluobai.jenkinslib.lib.hutool.core.annotation.SynthesizedAnnotationSelector}是合成注解生命周期中的第一个钩子，
 * 自定义选择器以拦截原始注解被扫描的过程。
 *
 ...
 * @see com.daluobai.jenkinslib.lib.hutool.core.annotation.AnnotationSynthesizer
