...
public interface SynthesizedAnnotation extends Annotation, Hierarchical, AnnotationAttributeValueProvider {
	 ...
	 * @return 注解属性
	 */
	Map<String, com.daluobai.jenkinslib.lib.hutool.core.annotation.AnnotationAttribute> getAttributes();
	 ...
	 */
	default void setAttributes(Map<String, com.daluobai.jenkinslib.lib.hutool.core.annotation.AnnotationAttribute> attributes) {
	 ...
	 */
	void setAttribute(String attributeName, com.daluobai.jenkinslib.lib.hutool.core.annotation.AnnotationAttribute attribute);
