...
import com.daluobai.jenkinslib.lib.hutool.core.annotation.CacheableAnnotationAttribute;
...
/**
 * {@link com.daluobai.jenkinslib.lib.hutool.core.annotation.SynthesizedAnnotation}的基本实现
 *
 * @param <R> 根对象类型
 * @param <T> 注解类型
...
public class GenericSynthesizedAnnotation<R, T extends Annotation> implements SynthesizedAnnotation {
	...
	private final Map<String, com.daluobai.jenkinslib.lib.hutool.core.annotation.AnnotationAttribute> attributeMethodCaches;
	 ...
	 * @return 注解属性
	 */
	protected Map<String, com.daluobai.jenkinslib.lib.hutool.core.annotation.AnnotationAttribute> loadAttributeMethods() {
	 ...
	 */
	@Override
	public Map<String, com.daluobai.jenkinslib.lib.hutool.core.annotation.AnnotationAttribute> getAttributes() {
	 ...
	 */
	@Override
	public void setAttribute(String attributeName, com.daluobai.jenkinslib.lib.hutool.core.annotation.AnnotationAttribute attribute) {
	 ...
	 */
	@Override
	public void replaceAttribute(String attributeName, UnaryOperator<com.daluobai.jenkinslib.lib.hutool.core.annotation.AnnotationAttribute> operator) {
		com.daluobai.jenkinslib.lib.hutool.core.annotation.AnnotationAttribute old = attributeMethodCaches.get(attributeName);
	...
	public Object getAttributeValue(String attributeName) {
		return Opt.ofNullable(attributeMethodCaches.get(attributeName))
			.map(com.daluobai.jenkinslib.lib.hutool.core.annotation.AnnotationAttribute::getValue)
			.get();
	}
