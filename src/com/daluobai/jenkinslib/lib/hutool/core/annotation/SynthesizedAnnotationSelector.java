...
public interface SynthesizedAnnotationSelector {
	 ...
	 * @return 被合成的注解
	 */
	<T extends com.daluobai.jenkinslib.lib.hutool.core.annotation.SynthesizedAnnotation> T choose(T oldAnnotation, T newAnnotation);
	...
	class NearestAndOldestPrioritySelector implements SynthesizedAnnotationSelector {
		@Override
		public <T extends com.daluobai.jenkinslib.lib.hutool.core.annotation.SynthesizedAnnotation> T choose(T oldAnnotation, T newAnnotation) {
			return com.daluobai.jenkinslib.lib.hutool.core.annotation.Hierarchical.Selector.NEAREST_AND_OLDEST_PRIORITY.choose(oldAnnotation, newAnnotation);
		}
	}
	...
	class NearestAndNewestPrioritySelector implements SynthesizedAnnotationSelector {
		@Override
		public <T extends com.daluobai.jenkinslib.lib.hutool.core.annotation.SynthesizedAnnotation> T choose(T oldAnnotation, T newAnnotation) {
			return com.daluobai.jenkinslib.lib.hutool.core.annotation.Hierarchical.Selector.NEAREST_AND_NEWEST_PRIORITY.choose(oldAnnotation, newAnnotation);
		}
	}
	...
	class FarthestAndOldestPrioritySelector implements SynthesizedAnnotationSelector {
		@Override
		public <T extends com.daluobai.jenkinslib.lib.hutool.core.annotation.SynthesizedAnnotation> T choose(T oldAnnotation, T newAnnotation) {
			return com.daluobai.jenkinslib.lib.hutool.core.annotation.Hierarchical.Selector.FARTHEST_AND_OLDEST_PRIORITY.choose(oldAnnotation, newAnnotation);
		}
	}
