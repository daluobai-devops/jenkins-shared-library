package com.daluobai.jenkinslib.lib.hutool.core.annotation.scanner;

import com.daluobai.jenkinslib.lib.hutool.core.annotation.scanner.AnnotationScanner;
import com.daluobai.jenkinslib.lib.hutool.core.annotation.scanner.ElementAnnotationScanner;
import com.daluobai.jenkinslib.lib.hutool.core.annotation.scanner.EmptyAnnotationScanner;
import com.daluobai.jenkinslib.lib.hutool.core.annotation.scanner.MetaAnnotationScanner;
import com.daluobai.jenkinslib.lib.hutool.core.annotation.scanner.MethodAnnotationScanner;
import com.daluobai.jenkinslib.lib.hutool.core.annotation.scanner.TypeAnnotationScanner;
 ...
 * @see com.daluobai.jenkinslib.lib.hutool.core.annotation.scanner.TypeAnnotationScanner
 * @see com.daluobai.jenkinslib.lib.hutool.core.annotation.scanner.MethodAnnotationScanner
 * @see com.daluobai.jenkinslib.lib.hutool.core.annotation.scanner.MetaAnnotationScanner
 * @see com.daluobai.jenkinslib.lib.hutool.core.annotation.scanner.ElementAnnotationScanner
 */
public class GenericAnnotationScanner implements com.daluobai.jenkinslib.lib.hutool.core.annotation.scanner.AnnotationScanner {

	/**
	 * 类型扫描器
	 */
	private final com.daluobai.jenkinslib.lib.hutool.core.annotation.scanner.AnnotationScanner typeScanner;

	/**
	 * 方法扫描器
	 */
	private final com.daluobai.jenkinslib.lib.hutool.core.annotation.scanner.AnnotationScanner methodScanner;

	/**
	 * 元注解扫描器
	 */
	private final com.daluobai.jenkinslib.lib.hutool.core.annotation.scanner.AnnotationScanner metaScanner;

	/**
	 * 普通元素扫描器
	 */
	private final com.daluobai.jenkinslib.lib.hutool.core.annotation.scanner.AnnotationScanner elementScanner;
