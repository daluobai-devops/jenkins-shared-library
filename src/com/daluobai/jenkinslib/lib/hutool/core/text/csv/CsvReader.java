...
import com.daluobai.jenkinslib.lib.hutool.core.text.csv.CsvBaseReader;
 ...
 * @since 4.0.1
 */
public class CsvReader extends CsvBaseReader implements Iterable<com.daluobai.jenkinslib.lib.hutool.core.text.csv.CsvRow>, Closeable {
	 ...
	 * @since 5.7.14
	 */
	public Stream<com.daluobai.jenkinslib.lib.hutool.core.text.csv.CsvRow> stream() {
