...
import com.daluobai.jenkinslib.lib.hutool.core.text.csv.CsvData;
import com.daluobai.jenkinslib.lib.hutool.core.text.csv.CsvParser;
import com.daluobai.jenkinslib.lib.hutool.core.text.csv.CsvReadConfig;
import com.daluobai.jenkinslib.lib.hutool.core.text.csv.CsvRow;
import com.daluobai.jenkinslib.lib.hutool.core.text.csv.CsvRowHandler;
...
public class CsvBaseReader implements Serializable {
	 ...
	 *
	 * @param file CSV文件
	 * @return {@link com.daluobai.jenkinslib.lib.hutool.core.text.csv.CsvData}，包含数据列表和行信息
	 * @throws IORuntimeException IO异常
	 */
	public com.daluobai.jenkinslib.lib.hutool.core.text.csv.CsvData read(File file) throws IORuntimeException {
	 ...
	 * @return {@link com.daluobai.jenkinslib.lib.hutool.core.text.csv.CsvData}，包含数据列表和行信息
	 */
	public com.daluobai.jenkinslib.lib.hutool.core.text.csv.CsvData readFromStr(String csvStr) {
	 ...
	 * @throws IORuntimeException IO异常
	 */
	public com.daluobai.jenkinslib.lib.hutool.core.text.csv.CsvData read(File file, Charset charset) throws IORuntimeException {
	 ...
	 * @throws IORuntimeException IO异常
	 */
	public com.daluobai.jenkinslib.lib.hutool.core.text.csv.CsvData read(Path path) throws IORuntimeException {
	 ...
	 * @throws IORuntimeException IO异常
	 */
	public com.daluobai.jenkinslib.lib.hutool.core.text.csv.CsvData read(Path path, Charset charset) throws IORuntimeException {
	 ...
	 * @throws IORuntimeException IO异常
	 */
	public com.daluobai.jenkinslib.lib.hutool.core.text.csv.CsvData read(Reader reader) throws IORuntimeException {
	 ...
	 * @throws IORuntimeException IO异常
	 */
	public com.daluobai.jenkinslib.lib.hutool.core.text.csv.CsvData read(Reader reader, boolean close) throws IORuntimeException {
		final com.daluobai.jenkinslib.lib.hutool.core.text.csv.CsvParser csvParser = parse(reader);
		...
		return new com.daluobai.jenkinslib.lib.hutool.core.text.csv.CsvData(header, rows);
	}
	 ...
	 * @param close      读取结束是否关闭{@link com.daluobai.jenkinslib.lib.hutool.core.text.csv.CsvParser}
	 * @param rowHandler 行处理器，用于一行一行的处理数据
	 * @throws IORuntimeException IO异常
	 * @since 5.0.4
	 */
	private void read(com.daluobai.jenkinslib.lib.hutool.core.text.csv.CsvParser csvParser, boolean close, CsvRowHandler rowHandler) throws IORuntimeException {
		try {
	...
	/**
	 * 构建 {@link com.daluobai.jenkinslib.lib.hutool.core.text.csv.CsvParser}
	 *
	 * @param reader Reader
	 * @return CsvParser
	 * @throws IORuntimeException IO异常
	 */
	protected com.daluobai.jenkinslib.lib.hutool.core.text.csv.CsvParser parse(Reader reader) throws IORuntimeException {
