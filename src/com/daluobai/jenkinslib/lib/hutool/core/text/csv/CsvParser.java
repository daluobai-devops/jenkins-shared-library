...
import com.daluobai.jenkinslib.lib.hutool.core.collection.ComputeIter;
...
import com.daluobai.jenkinslib.lib.hutool.core.text.csv.CsvTokener;
 ...
 * @author Looly
 */
public final class CsvParser extends ComputeIter<com.daluobai.jenkinslib.lib.hutool.core.text.csv.CsvRow> implements Closeable, Serializable {
	 ...
	 * 标题行
	 */
	private com.daluobai.jenkinslib.lib.hutool.core.text.csv.CsvRow header;
	/**
	 * 当前行号
	 */
	...
	@Override
	protected com.daluobai.jenkinslib.lib.hutool.core.text.csv.CsvRow computeNext() {
		return nextRow();
	}
	 ...
	 */
	public com.daluobai.jenkinslib.lib.hutool.core.text.csv.CsvRow nextRow() throws IORuntimeException {
		...
		while (!finished) {
			...
			return new com.daluobai.jenkinslib.lib.hutool.core.text.csv.CsvRow(lineNo, null == header ? null : header.headerMap, currentFields);
		}
