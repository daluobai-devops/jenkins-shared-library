package com.daluobai.jenkinslib.lib.hutool.core.text;

import com.daluobai.jenkinslib.lib.hutool.core.collection.CollUtil;
import com.daluobai.jenkinslib.lib.hutool.core.comparator.VersionComparator;
...
import com.daluobai.jenkinslib.lib.hutool.core.lang.Matcher;
import com.daluobai.jenkinslib.lib.hutool.core.lang.func.Func1;
import com.daluobai.jenkinslib.lib.hutool.core.text.NamingCase;
import com.daluobai.jenkinslib.lib.hutool.core.text.StrBuilder;
import com.daluobai.jenkinslib.lib.hutool.core.text.StrFormatter;
import com.daluobai.jenkinslib.lib.hutool.core.text.StrPool;
import com.daluobai.jenkinslib.lib.hutool.core.text.StrSplitter;
import com.daluobai.jenkinslib.lib.hutool.core.text.finder.CharFinder;
import com.daluobai.jenkinslib.lib.hutool.core.text.finder.Finder;
import com.daluobai.jenkinslib.lib.hutool.core.text.finder.StrFinder;
import com.daluobai.jenkinslib.lib.hutool.core.util.*;
...
public class CharSequenceUtil {
	...
	public static String[] splitToArray(CharSequence str, CharSequence separator) {
		...
		return com.daluobai.jenkinslib.lib.hutool.core.text.StrSplitter.splitToArray(str.toString(), str(separator), 0, false, false);
	}
	...
	public static String[] splitToArray(CharSequence text, char separator, int limit) {
		...
		return com.daluobai.jenkinslib.lib.hutool.core.text.StrSplitter.splitToArray(text.toString(), separator, limit, false, false);
	}
	...
	public static List<String> split(CharSequence str, char separator, int limit, boolean isTrim, boolean ignoreEmpty) {
		return com.daluobai.jenkinslib.lib.hutool.core.text.StrSplitter.split(str, separator, limit, isTrim, ignoreEmpty);
	}
	...
	public static <R> List<R> split(CharSequence str, char separator, int limit, boolean ignoreEmpty, Function<String, R> mapping) {
		return com.daluobai.jenkinslib.lib.hutool.core.text.StrSplitter.split(str, separator, limit, ignoreEmpty, mapping);
	}
	...
	public static List<String> split(CharSequence str, CharSequence separator, int limit, boolean isTrim, boolean ignoreEmpty) {
		...
		return com.daluobai.jenkinslib.lib.hutool.core.text.StrSplitter.split(str, separatorStr, limit, isTrim, ignoreEmpty);
	}
	 ...
	 * @param len 每一个小节的长度
	 * @return 截取后的字符串数组
	 * @see com.daluobai.jenkinslib.lib.hutool.core.text.StrSplitter#splitByLength(CharSequence, int)
	 */
	 ...
	 * @see com.daluobai.jenkinslib.lib.hutool.core.text.NamingCase#toUnderlineCase(CharSequence)
	 */
	public static String toUnderlineCase(CharSequence str) {
		return com.daluobai.jenkinslib.lib.hutool.core.text.NamingCase.toUnderlineCase(str);
	}
	 ...
	 * @see com.daluobai.jenkinslib.lib.hutool.core.text.NamingCase#toSymbolCase(CharSequence, char)
	 * @since 4.0.10
	 */
	public static String toSymbolCase(CharSequence str, char symbol) {
		return com.daluobai.jenkinslib.lib.hutool.core.text.NamingCase.toSymbolCase(str, symbol);
	}
	 ...
	 * @see com.daluobai.jenkinslib.lib.hutool.core.text.NamingCase#toCamelCase(CharSequence)
	 */
	public static String toCamelCase(CharSequence name) {
		return com.daluobai.jenkinslib.lib.hutool.core.text.NamingCase.toCamelCase(name);
	}
	 ...
	 * @param symbol 连接符
	 * @return 转换后的驼峰式命名的字符串
	 * @see com.daluobai.jenkinslib.lib.hutool.core.text.NamingCase#toCamelCase(CharSequence, char)
	 */
	 ...
	 * @return StrBuilder对象
	 */
	public static com.daluobai.jenkinslib.lib.hutool.core.text.StrBuilder strBuilder(CharSequence... strs) {
		return com.daluobai.jenkinslib.lib.hutool.core.text.StrBuilder.create(strs);
	}
	...
	public static String concat(boolean isNullToEmpty, CharSequence... strs) {
		final com.daluobai.jenkinslib.lib.hutool.core.text.StrBuilder sb = new StrBuilder();
		for (CharSequence str : strs) {
	 ...
	 *
	 * @param conjunction 分隔符 {@link com.daluobai.jenkinslib.lib.hutool.core.text.StrPool#COMMA}
	 * @param objs        数组
	 * @return 连接后的字符串
