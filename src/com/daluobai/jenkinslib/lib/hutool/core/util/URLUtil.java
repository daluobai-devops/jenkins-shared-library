...
import com.daluobai.jenkinslib.lib.hutool.core.io.IoUtil;
...
import com.daluobai.jenkinslib.lib.hutool.core.net.URLDecoder;
import com.daluobai.jenkinslib.lib.hutool.core.net.URLEncodeUtil;
import com.daluobai.jenkinslib.lib.hutool.core.net.url.UrlQuery;
import com.daluobai.jenkinslib.lib.hutool.core.util.CharUtil;
import com.daluobai.jenkinslib.lib.hutool.core.util.CharsetUtil;
...
public class URLUtil extends URLEncodeUtil {
	...
	public static URI getStringURI(CharSequence content) {
		...
		final String contentStr = com.daluobai.jenkinslib.lib.hutool.core.util.StrUtil.addPrefixIfNot(content, "string:///");
	...
	public static String completeUrl(String baseUrl, String relativePath) {
		...
		if (com.daluobai.jenkinslib.lib.hutool.core.util.StrUtil.isBlank(baseUrl)) {
			return null;
		}
	...
	public static String decode(String content, String charset) throws UtilException {
		return decode(content, com.daluobai.jenkinslib.lib.hutool.core.util.StrUtil.isEmpty(charset) ? null : CharsetUtil.charset(charset));
	}
	...
	public static URI toURI(String location, boolean isEncode) throws UtilException {
		...
		try {
			return new URI(com.daluobai.jenkinslib.lib.hutool.core.util.StrUtil.trim(location));
		} catch (URISyntaxException e) {
			throw new UtilException(e);
		}
	}
	...
	public static String normalize(String url, boolean isEncodePath, boolean replaceSlash) {
		if (com.daluobai.jenkinslib.lib.hutool.core.util.StrUtil.isBlank(url)) {
			return url;
		}
		...
		String body;
		if (sepIndex > 0) {
			protocol = com.daluobai.jenkinslib.lib.hutool.core.util.StrUtil.subPre(url, sepIndex + 3);
			body = com.daluobai.jenkinslib.lib.hutool.core.util.StrUtil.subSuf(url, sepIndex + 3);
		} else {
			protocol = "http://";
			body = url;
		}

		final int paramsSepIndex = com.daluobai.jenkinslib.lib.hutool.core.util.StrUtil.indexOf(body, '?');
		String params = null;
		if (paramsSepIndex > 0) {
			params = com.daluobai.jenkinslib.lib.hutool.core.util.StrUtil.subSuf(body, paramsSepIndex);
			body = com.daluobai.jenkinslib.lib.hutool.core.util.StrUtil.subPre(body, paramsSepIndex);
		}

		if (com.daluobai.jenkinslib.lib.hutool.core.util.StrUtil.isNotEmpty(body)) {
			// 去除开头的\或者/
			//noinspection ConstantConditions
			body = body.replaceAll("^[\\\\/]+", com.daluobai.jenkinslib.lib.hutool.core.util.StrUtil.EMPTY);
			// 替换\为/
			body = body.replace("\\", "/");
			if (replaceSlash) {
		...
		final int pathSepIndex = com.daluobai.jenkinslib.lib.hutool.core.util.StrUtil.indexOf(body, '/');
		String domain = body;
		String path = null;
		if (pathSepIndex > 0) {
			domain = com.daluobai.jenkinslib.lib.hutool.core.util.StrUtil.subPre(body, pathSepIndex);
			path = com.daluobai.jenkinslib.lib.hutool.core.util.StrUtil.subSuf(body, pathSepIndex);
		}
		if (isEncodePath) {
			path = encode(path);
		}
		return protocol + domain + com.daluobai.jenkinslib.lib.hutool.core.util.StrUtil.nullToEmpty(path) + com.daluobai.jenkinslib.lib.hutool.core.util.StrUtil.nullToEmpty(params);
	}
	...
	public static String getDataUri(String mimeType, Charset charset, String encoding, String data) {
		final StringBuilder builder = com.daluobai.jenkinslib.lib.hutool.core.util.StrUtil.builder("data:");
		if (com.daluobai.jenkinslib.lib.hutool.core.util.StrUtil.isNotBlank(mimeType)) {
