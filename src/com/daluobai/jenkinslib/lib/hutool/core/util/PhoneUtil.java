...
public class PhoneUtil {
	...
	public static CharSequence hideBefore(CharSequence phone) {
		return com.daluobai.jenkinslib.lib.hutool.core.util.StrUtil.hide(phone, 0, 7);
	}
	...
	public static CharSequence hideBetween(CharSequence phone) {
		return com.daluobai.jenkinslib.lib.hutool.core.util.StrUtil.hide(phone, 3, 7);
	}
	...
	public static CharSequence hideAfter(CharSequence phone) {
		return com.daluobai.jenkinslib.lib.hutool.core.util.StrUtil.hide(phone, 7, 11);
	}
	...
	public static CharSequence subBefore(CharSequence phone) {
		return com.daluobai.jenkinslib.lib.hutool.core.util.StrUtil.sub(phone, 0, 3);
	}
	...
	public static CharSequence subBetween(CharSequence phone) {
		return com.daluobai.jenkinslib.lib.hutool.core.util.StrUtil.sub(phone, 3, 7);
	}
	...
	{
		return com.daluobai.jenkinslib.lib.hutool.core.util.ReUtil.getGroup1(PatternPool.TEL, value);
	}
