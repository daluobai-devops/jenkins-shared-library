...
public class ModifierUtil {
	...
	public static boolean hasModifier(Class<?> clazz, ModifierType... modifierTypes) {
		if (null == clazz || com.daluobai.jenkinslib.lib.hutool.core.util.ArrayUtil.isEmpty(modifierTypes)) {
			return false;
		}
	...
	public static boolean hasModifier(Constructor<?> constructor, ModifierType... modifierTypes) {
		if (null == constructor || com.daluobai.jenkinslib.lib.hutool.core.util.ArrayUtil.isEmpty(modifierTypes)) {
			return false;
		}
	...
	public static boolean hasModifier(Method method, ModifierType... modifierTypes) {
		if (null == method || com.daluobai.jenkinslib.lib.hutool.core.util.ArrayUtil.isEmpty(modifierTypes)) {
			return false;
		}
	...
	public static boolean hasModifier(Field field, ModifierType... modifierTypes) {
		if (null == field || com.daluobai.jenkinslib.lib.hutool.core.util.ArrayUtil.isEmpty(modifierTypes)) {
			return false;
		}
