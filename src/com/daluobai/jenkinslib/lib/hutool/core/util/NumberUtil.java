...
import com.daluobai.jenkinslib.lib.hutool.core.math.Calculator;
...
import com.daluobai.jenkinslib.lib.hutool.core.util.RandomUtil;
...
public class NumberUtil {
	...
	public static BigDecimal add(Number... values) {
		if (com.daluobai.jenkinslib.lib.hutool.core.util.ArrayUtil.isEmpty(values)) {
	...
	public static BigDecimal add(String... values) {
		...
		for (int i = 1; i < values.length; i++) {
			value = values[i];
			if (com.daluobai.jenkinslib.lib.hutool.core.util.StrUtil.isNotBlank(value)) {
				result = result.add(toBigDecimal(value));
			}
		}
		return result;
	...
	public static BigDecimal mul(Number... values) {
		if (com.daluobai.jenkinslib.lib.hutool.core.util.ArrayUtil.isEmpty(values) || com.daluobai.jenkinslib.lib.hutool.core.util.ArrayUtil.hasNull(values)) {
			return BigDecimal.ZERO;
		}
	...
	public static BigDecimal div(Number v1, Number v2, int scale, RoundingMode roundingMode) {
		...
		return div(com.daluobai.jenkinslib.lib.hutool.core.util.StrUtil.toStringOrNull(v1), com.daluobai.jenkinslib.lib.hutool.core.util.StrUtil.toStringOrNull(v2), scale, roundingMode);
	}
	...
	public static boolean isInteger(String s) {
		if (com.daluobai.jenkinslib.lib.hutool.core.util.StrUtil.isBlank(s)) {
			return false;
		}
		try {
			Integer.parseInt(s);
	...
	public static int[] generateRandomNumber(int begin, int end, int size) {
		// 种子你可以随意生成，但不能重复
		final int[] seed = com.daluobai.jenkinslib.lib.hutool.core.util.ArrayUtil.range(begin, end);
	...
	public static BigInteger factorial(BigInteger start, BigInteger end) {
		...
		if (start.compareTo(BigInteger.ZERO) < 0 || end.compareTo(BigInteger.ZERO) < 0) {
			throw new IllegalArgumentException(com.daluobai.jenkinslib.lib.hutool.core.util.StrUtil.format("Factorial start and end both must be > 0, but got start={}, end={}", start, end));
		}
	...
	private static long factorialMultiplyAndCheck(long a, long b) {
		...
		throw new IllegalArgumentException(com.daluobai.jenkinslib.lib.hutool.core.util.StrUtil.format("Overflow in multiplication: {} * {}", a, b));
	}
	...
	public static long factorial(long n) {
		if (n < 0 || n > 20) {
			throw new IllegalArgumentException(com.daluobai.jenkinslib.lib.hutool.core.util.StrUtil.format("Factorial must have n >= 0 and n <= 20 for n!, but got n = {}", n));
		}
	 ...
	 * @return 是否相同
	 * @see com.daluobai.jenkinslib.lib.hutool.core.util.CharUtil#equals(char, char, boolean)
	 * @since 3.2.1
	 */
	 ...
	 * @return 最小值
	 * @see com.daluobai.jenkinslib.lib.hutool.core.util.ArrayUtil#min(Comparable[])
	 * @since 4.0.7
	 */
	public static <T extends Comparable<? super T>> T min(T[] numberArray) {
		return com.daluobai.jenkinslib.lib.hutool.core.util.ArrayUtil.min(numberArray);
	}
	 ...
	 * @param numberArray 数字数组
	 * @return 最小值
	 * @see com.daluobai.jenkinslib.lib.hutool.core.util.ArrayUtil#min(long...)
	 * @since 4.0.7
	 */
	 ...
	 * @param numberArray 数字数组
	 * @return 最小值
	 * @see com.daluobai.jenkinslib.lib.hutool.core.util.ArrayUtil#min(int...)
	 * @since 4.0.7
	 */
	 ...
	 * @param numberArray 数字数组
	 * @return 最小值
	 * @see com.daluobai.jenkinslib.lib.hutool.core.util.ArrayUtil#min(short...)
	 * @since 4.0.7
	 */
	 ...
	 * @param numberArray 数字数组
	 * @return 最小值
	 * @see com.daluobai.jenkinslib.lib.hutool.core.util.ArrayUtil#min(double...)
	 * @since 4.0.7
	 */
	 ...
	 * @param numberArray 数字数组
	 * @return 最小值
	 * @see com.daluobai.jenkinslib.lib.hutool.core.util.ArrayUtil#min(float...)
	 * @since 4.0.7
	 */
	 ...
	 * @param numberArray 数字数组
	 * @return 最大值
	 * @see com.daluobai.jenkinslib.lib.hutool.core.util.ArrayUtil#max(Comparable[])
	 * @since 4.0.7
	 */
	public static <T extends Comparable<? super T>> T max(T[] numberArray) {
		return com.daluobai.jenkinslib.lib.hutool.core.util.ArrayUtil.max(numberArray);
	}
	 ...
	 * @param numberArray 数字数组
	 * @return 最大值
	 * @see com.daluobai.jenkinslib.lib.hutool.core.util.ArrayUtil#max(long...)
	 * @since 4.0.7
	 */
	 ...
	 * @param numberArray 数字数组
	 * @return 最大值
	 * @see com.daluobai.jenkinslib.lib.hutool.core.util.ArrayUtil#max(int...)
	 * @since 4.0.7
	 */
	 ...
	 * @param numberArray 数字数组
	 * @return 最大值
	 * @see com.daluobai.jenkinslib.lib.hutool.core.util.ArrayUtil#max(short...)
	 * @since 4.0.7
	 */
	 ...
	 * @param numberArray 数字数组
	 * @return 最大值
	 * @see com.daluobai.jenkinslib.lib.hutool.core.util.ArrayUtil#max(double...)
	 * @since 4.0.7
	 */
	 ...
	 * @param numberArray 数字数组
	 * @return 最大值
	 * @see com.daluobai.jenkinslib.lib.hutool.core.util.ArrayUtil#max(float...)
	 * @since 4.0.7
	 */
	...
	public static BigDecimal toBigDecimal(String numberStr) {
		if (com.daluobai.jenkinslib.lib.hutool.core.util.StrUtil.isBlank(numberStr)) {
			return BigDecimal.ZERO;
		}
	...
	public static BigInteger toBigInteger(String number) {
		return com.daluobai.jenkinslib.lib.hutool.core.util.StrUtil.isBlank(number) ? BigInteger.ZERO : new BigInteger(number);
	}
	...
	public static BigInteger newBigInteger(String str) {
		str = com.daluobai.jenkinslib.lib.hutool.core.util.StrUtil.trimToNull(str);
		if (null == str) {
			return null;
		}
	...
	public static int parseInt(String number) throws NumberFormatException {
		if (com.daluobai.jenkinslib.lib.hutool.core.util.StrUtil.isBlank(number)) {
			return 0;
		}

		if (com.daluobai.jenkinslib.lib.hutool.core.util.StrUtil.startWithIgnoreCase(number, "0x")) {
			// 0x04表示16进制数
			return Integer.parseInt(number.substring(2), 16);
		}

		if (com.daluobai.jenkinslib.lib.hutool.core.util.StrUtil.containsIgnoreCase(number, "E")) {
			// 科学计数法忽略支持，科学计数法一般用于表示非常小和非常大的数字，这类数字转换为int后精度丢失，没有意义。
			throw new NumberFormatException(com.daluobai.jenkinslib.lib.hutool.core.util.StrUtil.format("Unsupported int format: [{}]", number));
		}
	...
	public static Number parseNumber(String numberStr) throws NumberFormatException {
		if (com.daluobai.jenkinslib.lib.hutool.core.util.StrUtil.startWithIgnoreCase(numberStr, "0x")) {
			// 0x04表示16进制数
			return Long.parseLong(numberStr.substring(2), 16);
		} else if (com.daluobai.jenkinslib.lib.hutool.core.util.StrUtil.startWith(numberStr, '+')) {
			// issue#I79VS7
