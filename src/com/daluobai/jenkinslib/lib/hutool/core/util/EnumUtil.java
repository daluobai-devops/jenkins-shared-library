...
public class EnumUtil {
	...
	public static <E extends Enum<E>> E fromString(Class<E> enumClass, String value) {
		if (null == enumClass || com.daluobai.jenkinslib.lib.hutool.core.util.StrUtil.isBlank(value)) {
			return null;
		}
	...
	public static <E extends Enum<E>, C> E getBy(Class<E> enumClass, Func1<E, C> condition, C value) {
		...
		return getBy(enumClass, constant -> com.daluobai.jenkinslib.lib.hutool.core.util.ObjUtil.equals(condition.callWithRuntimeException(constant), value));
	}
	...
	public static boolean equalsIgnoreCase(final Enum<?> e, String val) {
		return com.daluobai.jenkinslib.lib.hutool.core.util.StrUtil.equalsIgnoreCase(toString(e), val);
	}
