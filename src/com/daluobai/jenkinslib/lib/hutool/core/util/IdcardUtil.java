...
import com.daluobai.jenkinslib.lib.hutool.core.lang.Validator;
...
public class IdcardUtil {
	...
	public static String convert15To18(String idCard) {
		...
		if (com.daluobai.jenkinslib.lib.hutool.core.util.ReUtil.isMatch(PatternPool.NUMBERS, idCard)) {
			// 获取出生年月日
			...
			idCard18 = com.daluobai.jenkinslib.lib.hutool.core.util.StrUtil.builder().append(idCard, 0, 6).append(sYear).append(idCard.substring(8));
			// 获取校验位
	...
	public static String convert18To15(String idCard) {
		if (com.daluobai.jenkinslib.lib.hutool.core.util.StrUtil.isNotBlank(idCard) && IdcardUtil.isValidCard18(idCard)) {
	...
	public static boolean isValidCard(String idCard) {
		if (com.daluobai.jenkinslib.lib.hutool.core.util.StrUtil.isBlank(idCard)) {
			return false;
		}
	...
	public static boolean isValidCard18(String idcard, boolean ignoreCase) {
		...
		if (com.daluobai.jenkinslib.lib.hutool.core.util.ReUtil.isMatch(PatternPool.NUMBERS, code17)) {
			// 获取校验位
	...
	public static String[] isValidCard10(String idcard) {
		...
		idcard = com.daluobai.jenkinslib.lib.hutool.core.util.StrUtil.replace(idcard, "（", "(");
		idcard = com.daluobai.jenkinslib.lib.hutool.core.util.StrUtil.replace(idcard, "）", ")");
	...
	public static String getProvinceByIdCard(String idcard) {
		...
		if (com.daluobai.jenkinslib.lib.hutool.core.util.StrUtil.isNotBlank(code)) {
	 ...
	 * @return 隐藏后的身份证号码
	 * @see com.daluobai.jenkinslib.lib.hutool.core.util.StrUtil#hide(CharSequence, int, int)
	 * @since 3.2.2
	 */
	public static String hide(String idcard, int startInclude, int endExclude) {
		return com.daluobai.jenkinslib.lib.hutool.core.util.StrUtil.hide(idcard, startInclude, endExclude);
	}
