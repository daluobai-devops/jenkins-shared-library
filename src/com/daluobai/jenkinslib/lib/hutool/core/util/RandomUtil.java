...
import com.daluobai.jenkinslib.lib.hutool.core.lang.WeightRandom;
import com.daluobai.jenkinslib.lib.hutool.core.lang.WeightRandom.WeightObj;
...
public class RandomUtil {
	...
	public static int[] randomInts(final int length) {
		final int[] range = com.daluobai.jenkinslib.lib.hutool.core.util.ArrayUtil.range(length);
		for (int i = 0; i < length; i++) {
			final int random = randomInt(i, length);
			com.daluobai.jenkinslib.lib.hutool.core.util.ArrayUtil.swap(range, i, random);
		}
		return range;
	}
	// endregion
	...
	public static double randomDouble(final double minInclude, final double maxExclude, final int scale,
		...
		return com.daluobai.jenkinslib.lib.hutool.core.util.NumberUtil.round(randomDouble(minInclude, maxExclude), scale, roundingMode).doubleValue();
	}
	...
	public static double randomDouble(final int scale, final RoundingMode roundingMode) {
		return com.daluobai.jenkinslib.lib.hutool.core.util.NumberUtil.round(randomDouble(), scale, roundingMode).doubleValue();
	}
	...
	public static double randomDouble(final double limit, final int scale, final RoundingMode roundingMode) {
		return com.daluobai.jenkinslib.lib.hutool.core.util.NumberUtil.round(randomDouble(limit), scale, roundingMode).doubleValue();
	}
	// endregion
	...
	public static BigDecimal randomBigDecimal() {
		return com.daluobai.jenkinslib.lib.hutool.core.util.NumberUtil.toBigDecimal(getRandom().nextDouble());
	}
	...
	public static BigDecimal randomBigDecimal(final BigDecimal limit) {
		return com.daluobai.jenkinslib.lib.hutool.core.util.NumberUtil.toBigDecimal(getRandom().nextDouble(limit.doubleValue()));
	}
	...
	public static String randomStringWithoutStr(final int length, final String elemData) {
		...
		baseStr = com.daluobai.jenkinslib.lib.hutool.core.util.StrUtil.removeAll(baseStr, elemData.toCharArray());
	...
	public static String randomStringLowerWithoutStr(final int length, final String elemData) {
		...
		baseStr = com.daluobai.jenkinslib.lib.hutool.core.util.StrUtil.removeAll(baseStr, elemData.toLowerCase().toCharArray());
		return randomString(baseStr, length);
	}
	...
	public static String randomString(final String baseString, int length) {
		if (com.daluobai.jenkinslib.lib.hutool.core.util.StrUtil.isEmpty(baseString)) {
