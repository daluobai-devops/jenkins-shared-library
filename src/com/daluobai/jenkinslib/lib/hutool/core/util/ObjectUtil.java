...
import com.daluobai.jenkinslib.lib.hutool.core.util.ReflectUtil;
import com.daluobai.jenkinslib.lib.hutool.core.util.SerializeUtil;
...
public class ObjectUtil {
	...
	public static boolean equal(Object obj1, Object obj2) {
		if (obj1 instanceof Number && obj2 instanceof Number) {
			return com.daluobai.jenkinslib.lib.hutool.core.util.NumberUtil.equals((Number) obj1, (Number) obj2);
		}
	...
	public static boolean isEmpty(Object obj) {
		...
		if (obj instanceof CharSequence) {
			return com.daluobai.jenkinslib.lib.hutool.core.util.StrUtil.isEmpty((CharSequence) obj);
		...
		} else if (com.daluobai.jenkinslib.lib.hutool.core.util.ArrayUtil.isArray(obj)) {
			return com.daluobai.jenkinslib.lib.hutool.core.util.ArrayUtil.isEmpty(obj);
		}
	...
	public static <T> T defaultIfEmpty(String str, Supplier<? extends T> handle, final T defaultValue) {
		if (com.daluobai.jenkinslib.lib.hutool.core.util.StrUtil.isNotEmpty(str)) {
			return handle.get();
		}
		return defaultValue;
	}
	...
	public static <T extends CharSequence> T defaultIfEmpty(final T str, final T defaultValue) {
		return com.daluobai.jenkinslib.lib.hutool.core.util.StrUtil.isEmpty(str) ? defaultValue : str;
	}
	...
	public static <T extends CharSequence> T defaultIfEmpty(T str, Supplier<? extends T> defaultValueSupplier) {
		if (com.daluobai.jenkinslib.lib.hutool.core.util.StrUtil.isEmpty(str)) {
			return defaultValueSupplier.get();
		}
		return str;
	}
	...
	public static <T extends CharSequence> T defaultIfBlank(final T str, final T defaultValue) {
		return com.daluobai.jenkinslib.lib.hutool.core.util.StrUtil.isBlank(str) ? defaultValue : str;
	}
	...
	public static <T> T clone(T obj) {
		T result = com.daluobai.jenkinslib.lib.hutool.core.util.ArrayUtil.clone(obj);
		if (null == result) {
	 ...
	 * @return 是否为基本类型
	 * @see com.daluobai.jenkinslib.lib.hutool.core.util.ClassUtil#isBasicType(Class)
	 */
	public static boolean isBasicType(Object object) {
		if (null == object) {
			return false;
		}
		return com.daluobai.jenkinslib.lib.hutool.core.util.ClassUtil.isBasicType(object.getClass());
	}
	...
	public static int emptyCount(Object... objs) {
		return com.daluobai.jenkinslib.lib.hutool.core.util.ArrayUtil.emptyCount(objs);
	}
	 ...
	 * @param objs 被检查对象
	 * @return 是否存在
	 * @see com.daluobai.jenkinslib.lib.hutool.core.util.ArrayUtil#hasNull(Object[])
	 * @since 5.5.3
	 */
	public static boolean hasNull(Object... objs) {
		return com.daluobai.jenkinslib.lib.hutool.core.util.ArrayUtil.hasNull(objs);
	}
	 ...
	 * @param objs 被检查对象
	 * @return 是否存在
	 * @see com.daluobai.jenkinslib.lib.hutool.core.util.ArrayUtil#hasEmpty(Object...)
	 */
	public static boolean hasEmpty(Object... objs) {
		return com.daluobai.jenkinslib.lib.hutool.core.util.ArrayUtil.hasEmpty(objs);
	}
	...
	public static boolean isAllEmpty(Object... objs) {
		return com.daluobai.jenkinslib.lib.hutool.core.util.ArrayUtil.isAllEmpty(objs);
	}
