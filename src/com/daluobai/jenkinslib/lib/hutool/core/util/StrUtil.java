...
import com.daluobai.jenkinslib.lib.hutool.core.text.TextSimilarity;
...
import com.daluobai.jenkinslib.lib.hutool.core.util.IdUtil;
...
public class StrUtil extends CharSequenceUtil implements StrPool {
	 ...
	 *
	 * @return UUID字符串
	 * @see com.daluobai.jenkinslib.lib.hutool.core.util.IdUtil#randomUUID()
	 * @since 4.0.10
	 */
