...
import com.daluobai.jenkinslib.lib.hutool.core.math.Arrangement;
import com.daluobai.jenkinslib.lib.hutool.core.math.Combination;
import com.daluobai.jenkinslib.lib.hutool.core.math.Money;

import java.util.List;

/**
 * 数学相关方法工具类<br>
 * 此工具类与{@link com.daluobai.jenkinslib.lib.hutool.core.util.NumberUtil}属于一类工具，NumberUtil偏向于简单数学计算的封装，MathUtil偏向复杂数学计算
 *
 * @author looly
 * @since 4.0.7
 */
public class MathUtil {
	...
	public static long yuanToCent(double yuan) {
		return new com.daluobai.jenkinslib.lib.hutool.core.math.Money(yuan).getCent();
	}
