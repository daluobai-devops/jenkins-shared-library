package com.daluobai.jenkinslib.lib.hutool.core.convert;
...
import com.daluobai.jenkinslib.lib.hutool.core.convert.TypeConverter;
import com.daluobai.jenkinslib.lib.hutool.core.convert.impl.*;
import com.daluobai.jenkinslib.lib.hutool.core.date.DateTime;
import com.daluobai.jenkinslib.lib.hutool.core.lang.Opt;
import com.daluobai.jenkinslib.lib.hutool.core.lang.Pair;
import com.daluobai.jenkinslib.lib.hutool.core.lang.TypeReference;
...
public class ConverterRegistry implements Serializable {
	 ...
	 * 默认类型转换器
	 */
	private Map<Class<?>, com.daluobai.jenkinslib.lib.hutool.core.convert.Converter<?>> defaultConverterMap;
	/**
	 * 用户自定义类型转换器
	 */
	private volatile Map<Type, com.daluobai.jenkinslib.lib.hutool.core.convert.Converter<?>> customConverterMap;
	...
	private void putCustomBySpi() {
		ServiceLoaderUtil.load(com.daluobai.jenkinslib.lib.hutool.core.convert.Converter.class).forEach(converter -> {
			try {
	 ...
	 * @return ConverterRegistry
	 */
	public ConverterRegistry putCustom(Type type, Class<? extends com.daluobai.jenkinslib.lib.hutool.core.convert.Converter<?>> converterClass) {
	 ...
	 * @return ConverterRegistry
	 */
	public ConverterRegistry putCustom(Type type, com.daluobai.jenkinslib.lib.hutool.core.convert.Converter<?> converter) {
	 ...
	 * @return 转换器
	 */
	public <T> com.daluobai.jenkinslib.lib.hutool.core.convert.Converter<T> getConverter(Type type, boolean isCustomFirst) {
		com.daluobai.jenkinslib.lib.hutool.core.convert.Converter<T> converter;
		if (isCustomFirst) {
	...
	public <T> com.daluobai.jenkinslib.lib.hutool.core.convert.Converter<T> getDefaultConverter(Type type) {
		final Class<?> key = TypeUtil.getClass(type);
		return (null == defaultConverterMap || null == key) ? null : (com.daluobai.jenkinslib.lib.hutool.core.convert.Converter<T>) defaultConverterMap.get(key);
	}
	 ...
	 */
	@SuppressWarnings("unchecked")
	public <T> com.daluobai.jenkinslib.lib.hutool.core.convert.Converter<T> getCustomConverter(Type type) {
		return (null == customConverterMap) ? null : (com.daluobai.jenkinslib.lib.hutool.core.convert.Converter<T>) customConverterMap.get(type);
	}
	 ...
	 * @param isCustomFirst 是否自定义转换器优先
	 * @return 转换后的值
	 * @throws com.daluobai.jenkinslib.lib.hutool.core.convert.ConvertException 转换器不存在
	 */
	@SuppressWarnings("unchecked")
	public <T> T convert(Type type, Object value, T defaultValue, boolean isCustomFirst) throws com.daluobai.jenkinslib.lib.hutool.core.convert.ConvertException {
		...
		// 自定义对象转换
		if(value instanceof com.daluobai.jenkinslib.lib.hutool.core.convert.TypeConverter){
		...
		// 无法转换
		throw new com.daluobai.jenkinslib.lib.hutool.core.convert.ConvertException("Can not Converter from [{}] to [{}]", value.getClass().getName(), type.getTypeName());
	}
	 ...
	 * @throws com.daluobai.jenkinslib.lib.hutool.core.convert.ConvertException 转换器不存在
	 */
	public <T> T convert(Type type, Object value, T defaultValue) throws com.daluobai.jenkinslib.lib.hutool.core.convert.ConvertException {
