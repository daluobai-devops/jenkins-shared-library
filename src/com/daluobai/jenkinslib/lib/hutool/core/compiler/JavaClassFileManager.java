...
import com.daluobai.jenkinslib.lib.hutool.core.compiler.JavaClassFileObject;
import com.daluobai.jenkinslib.lib.hutool.core.io.resource.FileObjectResource;
import com.daluobai.jenkinslib.lib.hutool.core.lang.ResourceClassLoader;
...
class JavaClassFileManager extends ForwardingJavaFileManager<JavaFileManager> {
	...
	public JavaFileObject getJavaFileForOutput(final Location location, final String className, final Kind kind, final FileObject sibling) {
		final JavaFileObject javaFileObject = new com.daluobai.jenkinslib.lib.hutool.core.compiler.JavaClassFileObject(className);
