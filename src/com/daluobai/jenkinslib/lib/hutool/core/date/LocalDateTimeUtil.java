...
import com.daluobai.jenkinslib.lib.hutool.core.date.DatePattern;
import com.daluobai.jenkinslib.lib.hutool.core.date.DateTime;
import com.daluobai.jenkinslib.lib.hutool.core.date.TemporalAccessorUtil;
import com.daluobai.jenkinslib.lib.hutool.core.date.TemporalUtil;
 ...
 *
 * @author looly
 * @see com.daluobai.jenkinslib.lib.hutool.core.date.DatePattern 常用格式工具类
 * @since 5.3.9
 */
public class LocalDateTimeUtil {
	...
	public static LocalDateTime parse(CharSequence text, String format) {
		...
		if (StrUtil.isNotBlank(format)) {
			...
			if (StrUtil.startWithIgnoreEquals(format, com.daluobai.jenkinslib.lib.hutool.core.date.DatePattern.PURE_DATETIME_PATTERN)) {
				final String fraction = StrUtil.removePrefix(format, com.daluobai.jenkinslib.lib.hutool.core.date.DatePattern.PURE_DATETIME_PATTERN);
				...
				formatter = new DateTimeFormatterBuilder()
						.appendPattern(com.daluobai.jenkinslib.lib.hutool.core.date.DatePattern.PURE_DATETIME_PATTERN)
	...
	public static String formatNormal(LocalDateTime time) {
		return format(time, com.daluobai.jenkinslib.lib.hutool.core.date.DatePattern.NORM_DATETIME_FORMATTER);
	}
	...
	public static String formatNormal(LocalDate date) {
		return format(date, com.daluobai.jenkinslib.lib.hutool.core.date.DatePattern.NORM_DATE_FORMATTER);
	}
	 ...
	 *
	 * @param date      {@link LocalDate}
	 * @param formatter 日期格式化器，预定义的格式见：{@link DateTimeFormatter}; 常量如： {@link com.daluobai.jenkinslib.lib.hutool.core.date.DatePattern#NORM_DATE_FORMATTER}, {@link com.daluobai.jenkinslib.lib.hutool.core.date.DatePattern#NORM_DATETIME_FORMATTER}
	 * @return 格式化后的字符串
	 * @since 5.3.10
	 */
	 ...
	 *
	 * @param date   {@link LocalDate}
	 * @param format 日期格式，类似于yyyy-MM-dd, 常量如 {@link com.daluobai.jenkinslib.lib.hutool.core.date.DatePattern#NORM_DATE_PATTERN}, {@link DatePattern#NORM_DATETIME_PATTERN}
	 * @return 格式化后的字符串
	 * @since 5.3.10
	 */
	...
	public static LocalDateTime offset(LocalDateTime time, long number, TemporalUnit field) {
		return com.daluobai.jenkinslib.lib.hutool.core.date.TemporalUtil.offset(time, number, field);
	}
	 ...
	 * @see com.daluobai.jenkinslib.lib.hutool.core.date.TemporalUtil#between(Temporal, Temporal)
	 */
	public static Duration between(LocalDateTime startTimeInclude, LocalDateTime endTimeExclude) {
		return com.daluobai.jenkinslib.lib.hutool.core.date.TemporalUtil.between(startTimeInclude, endTimeExclude);
	}
	 ...
	 * @since 5.7.14
	 */
	public static com.daluobai.jenkinslib.lib.hutool.core.date.Week dayOfWeek(LocalDate localDate) {
