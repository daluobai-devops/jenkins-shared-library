...
public class Zodiac {
	 ...
	 * @since 4.5.0
	 */
	public static String getZodiac(com.daluobai.jenkinslib.lib.hutool.core.date.Month month, int day) {
	 ...
	 * 通过生日计算星座
	 *
	 * @param month 月，从0开始计数，见{@link com.daluobai.jenkinslib.lib.hutool.core.date.Month#getValue()}
	 * @param day 天
	 * @return 星座名
	 */
	public static String getZodiac(int month, int day) {
		Assert.checkBetween(month,
			com.daluobai.jenkinslib.lib.hutool.core.date.Month.JANUARY.getValue(),
