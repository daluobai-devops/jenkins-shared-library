...
import com.daluobai.jenkinslib.lib.hutool.core.date.CalendarUtil;
import com.daluobai.jenkinslib.lib.hutool.core.date.DateTime;
import com.daluobai.jenkinslib.lib.hutool.core.date.DateUtil;
import com.daluobai.jenkinslib.lib.hutool.core.date.LocalDateTimeUtil;
import com.daluobai.jenkinslib.lib.hutool.core.date.Zodiac;
import com.daluobai.jenkinslib.lib.hutool.core.date.chinese.ChineseMonth;
import com.daluobai.jenkinslib.lib.hutool.core.date.chinese.GanZhi;
import com.daluobai.jenkinslib.lib.hutool.core.date.chinese.LunarFestival;
import com.daluobai.jenkinslib.lib.hutool.core.date.chinese.LunarInfo;
import com.daluobai.jenkinslib.lib.hutool.core.date.chinese.SolarTerms;
...
public class ChineseDate {
	...
	public ChineseDate(int chineseYear, int chineseMonth, int chineseDay, boolean isLeapMonth) {
		...
		final com.daluobai.jenkinslib.lib.hutool.core.date.DateTime dateTime = lunar2solar(chineseYear, chineseMonth, chineseDay, isLeapMonth);
		if (null != dateTime) {
			//初始化公历年
	...
	public Date getGregorianDate() {
		return com.daluobai.jenkinslib.lib.hutool.core.date.DateUtil.date(getGregorianCalendar());
	}
