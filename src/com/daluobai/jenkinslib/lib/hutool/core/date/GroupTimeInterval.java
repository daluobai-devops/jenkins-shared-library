...
public class GroupTimeInterval implements Serializable {
	 ...
	 * @return 从开始到当前的间隔时间（毫秒数）
	 */
	public long interval(String id, com.daluobai.jenkinslib.lib.hutool.core.date.DateUnit dateUnit) {
		final long intervalMs = isNano ? interval(id) / 1000000L : interval(id);
		if (com.daluobai.jenkinslib.lib.hutool.core.date.DateUnit.MS == dateUnit) {
			return intervalMs;
		}
	...
	public long intervalMs(String id) {
		return interval(id, com.daluobai.jenkinslib.lib.hutool.core.date.DateUnit.MS);
	}
	...
	public long intervalSecond(String id) {
		return interval(id, com.daluobai.jenkinslib.lib.hutool.core.date.DateUnit.SECOND);
	}
	...
	public long intervalMinute(String id) {
		return interval(id, com.daluobai.jenkinslib.lib.hutool.core.date.DateUnit.MINUTE);
	}
	...
	public long intervalHour(String id) {
		return interval(id, com.daluobai.jenkinslib.lib.hutool.core.date.DateUnit.HOUR);
	}
	...
	public long intervalDay(String id) {
		return interval(id, com.daluobai.jenkinslib.lib.hutool.core.date.DateUnit.DAY);
	}
