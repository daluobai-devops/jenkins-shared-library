...
import com.daluobai.jenkinslib.lib.hutool.core.date.BetweenFormatter;
...
public class DateBetween implements Serializable {
	 ...
	 * @return 时长差
	 */
	public long between(com.daluobai.jenkinslib.lib.hutool.core.date.DateUnit unit) {
	...
	public long betweenMonth(boolean isReset) {
		final Calendar beginCal = com.daluobai.jenkinslib.lib.hutool.core.date.DateUtil.calendar(begin);
		final Calendar endCal = com.daluobai.jenkinslib.lib.hutool.core.date.DateUtil.calendar(end);
	 ...
	 * @since 5.7.17
	 */
	public String toString(com.daluobai.jenkinslib.lib.hutool.core.date.DateUnit unit, BetweenFormatter.Level level) {
