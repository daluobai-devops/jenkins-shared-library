...
public class BetweenFormatter implements Serializable {
	...
	public String format() {
		...
		if (betweenMs > 0) {
			long day = betweenMs / com.daluobai.jenkinslib.lib.hutool.core.date.DateUnit.DAY.getMillis();
			long hour = betweenMs / com.daluobai.jenkinslib.lib.hutool.core.date.DateUnit.HOUR.getMillis() - day * 24;
			long minute = betweenMs / com.daluobai.jenkinslib.lib.hutool.core.date.DateUnit.MINUTE.getMillis() - day * 24 * 60 - hour * 60;
