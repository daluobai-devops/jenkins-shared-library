...
//        }
        ...
        //判断用哪种方式管理服务
        def manageBySystemctl = StrUtils.isBlank(parameterMap.manageBy) || parameterMap.manageBy == "systemctl"
    ...
    def reStartBySystemctl(Map parameterMap){
        ...
        def pathRoot = parameterMap.pathRoot
        def javaPath = ObjUtils.isEmpty(parameterMap.javaPath) ? "/usr/local/bin/java" : parameterMap.javaPath
        //获取登录的用户
